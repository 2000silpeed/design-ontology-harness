...
- **Active roles**:
  - `anchor_background` -> Navy Blue #000080 / blue.deep
  - `depth_support` -> Prussian Blue #003153 / blue.deep
  - `interface_surface` -> Classic Blue #0F4C81 / blue.pantone_trend
  - `highlight_air` -> Ice Blue #D6EAF8 / blue.pastel
  - `proof_accent` -> Amber #FFBF00 / yellow.standard
- **Selected colors**:
  - Navy Blue #000080 / blue.deep / 신뢰, 권위, 집중, 전문성, 절제된 우아함
  - Prussian Blue #003153 / blue.deep / 고전, 예술, 집중, 권위, 깊이감
  - Classic Blue #0F4C81 / blue.pantone_trend / 신뢰, 평온함, 지성, 안정감
  - Amber #FFBF00 / yellow.standard / 따뜻함, 세련됨, 고급스러움, 안정감
  - Ice Blue #D6EAF8 / blue.pastel / 정제됨, 청결함, 섬세함, 평온, 투명
- **Palette candidates**:
...
- **Expanded supporting colors**:
  ...
  - Ochre #CC7722 / Standard Oranges / reference-color / Ochre stays inside the preferred families.; Ochre reinforces the brand mood signals.
...
- **Expanded semantic roles**:
  ...
  - `ink` -> Prussian Blue #003153 / blue.deep
...
- **Combination lists**:
  - Seed Core: anchor_background=Navy Blue, depth_support=Prussian Blue, interface_surface=Classic Blue, highlight_air=Ice Blue, proof_accent=Amber
  - Surface System: canvas=Canvas White, surface=Paper, border=Border Neutral, ink=Prussian Blue, ink_muted=Muted Ink
  - Support Spectrum: support=Wheat, support=Ochre, support=Apricot, support=Terracotta, support=Amber, support=Classic Blue
  - Semantic States: info=Lavender Violet, success=Forest Green, warning=Wheat, danger=Terracotta
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=151.28): anchor_background=Navy Blue, depth_support=Prussian Blue, interface_surface=Classic Blue, highlight_air=Ice Blue, proof_accent=Amber
  - ontology-quiet-surface-2 (Quiet Surface, score=103.62): anchor_background=Prussian Blue, depth_support=Powder Blue, interface_surface=Coral Blush, highlight_air=Mauve, proof_accent=Burnt Orange
  - ontology-clear-structure-3 (Clear Structure, score=95.43): anchor_background=Classic Blue, depth_support=Misty Blue, interface_surface=Azure Blue, highlight_air=Mauve, proof_accent=Byzantium
  - ontology-strong-signal-4 (Strong Signal, score=95.17): anchor_background=Ice Blue, depth_support=Burnt Orange, interface_surface=Azure Blue, highlight_air=Misty Blue, proof_accent=Byzantium
  - ontology-cross-family-5 (Cross Family, score=106.82): anchor_background=Misty Blue, depth_support=Ice Blue, interface_surface=Classic Blue, highlight_air=Cornsilk, proof_accent=Byzantium
- **Selection rules**:
...
- **Matched color keywords**:
  - `anchor_background` -> Navy Blue #000080 / blue.deep / mood=신뢰, 권위, 집중 / axes=low_value, mid_chroma, cool_bias
  - `depth_support` -> Prussian Blue #003153 / blue.deep / mood=고전, 예술, 집중 / axes=low_value, low_chroma, cool_bias
  - `interface_surface` -> Classic Blue #0F4C81 / blue.pantone_trend / mood=신뢰, 평온함, 지성 / axes=mid_value, low_value, mid_chroma
  - `highlight_air` -> Ice Blue #D6EAF8 / blue.pastel / mood=정제됨, 청결함, 섬세함 / axes=high_value, low_chroma, cool_bias
  - `proof_accent` -> Amber #FFBF00 / yellow.standard / mood=따뜻함, 세련됨, 고급스러움 / axes=mid_value, mid_chroma, warm_bias
- **Ontology keyword recommendations**:
  - Coral Blush #F88379 / orange.pastel / matches 'low_chroma'; matches 'pastel'
  ...
  - Copper #B87333 / orange.deep / matches 'orange'; matches '고급스러움'
...
- **Density**: airy (confidence 0.94, provenance inferred) / editorial x5.300000000000001, landing x4.3500000000000005, hero x2.4
- **Surface Style**: tinted (confidence 0.63, provenance inferred) / warm x3.6500000000000004, editorial x5.300000000000001
- **Corner Style**: pill (confidence 0.38, provenance inferred) / svg corner ratio 0.50
- **Typography Mood**: editorial (confidence 0.94, provenance inferred) / editorial x5.300000000000001, serif x1.95
- **Color balance**: temperature=warm, contrast=high, neutral_bias=moderate, provenance=observed / dominant #D9B7A2, #FFF9F3, #8A6A58

### Layout Rhythm

- **Dashboard grid**: confidence 0.94 / provenance inferred / dashboard x4.3500000000000005, 3:2-ish x2
- **Editorial feed**: confidence 0.94 / provenance inferred / editorial x5.300000000000001
- **Narrative landing flow**: confidence 0.94 / provenance inferred / landing x4.3500000000000005, hero x2.4, pricing x0.9, testimonial x0.9
- **Split-pane workspace**: confidence 0.83 / provenance inferred / workspace x1.8, editor x0.9, navigation x0.9, command x0.9
...
- **Context cards**:
  - `source-01-image-01` (visual-screen, observed): editorial-dashboard-split-pane / flows: dashboard / morphology: split-pane
  - `source-01-image-02` (visual-screen, observed): landing-hero-serif-trust-strip / flows: dashboard / morphology: split-pane
  - `research-query-01` (research-query, planned): editorial dashboard ui / flows: dashboard / morphology: general-interface-composition
  - `research-query-02` (research-query, planned): warm premium onboarding flow / flows: onboarding / morphology: general-interface-composition
  - `research-query-03` (research-query, planned): serif product landing page / flows: general-product-ui / morphology: general-interface-composition
- **Research gaps**:
...
- **Required families**: button, data-display, editorial, feedback, input, layout, marketing, navigation, workflow, foundation, overlay, surface
...
- **filter-builder** (input, score 6): users need AND/OR logic across several fields; filters should be saved, shared, or audited / pairs with: saved-view-bar, bulk-action-table, exception-queue
- **resizable-split-pane** (layout, score 6): primary work happens between list, canvas/chat, and detail panels; users need to compare or inspect adjacent information without navigation / pairs with: thread-list, artifact-preview-panel, inspector-drawer
- **risk-summary-card** (data-display, score 6): users need a fast read of risk before drilling into policy details; AI confidence or compliance severity must be visible / pairs with: policy-matrix, confidence-meter, exception-queue
- **saved-view-bar** (navigation, score 6): teams revisit the same filtered views often; dense tools need stable scope memory / pairs with: filter-builder, bulk-action-table, exception-queue
- **approval-rail** (workflow, score 4): work requires review, approval, rejection, or handoff; users need to know who owns the next decision / pairs with: policy-matrix, risk-summary-card, diff-viewer
- **audit-timeline** (data-display, score 4): regulated workflows require traceable user and AI actions; reviewers need to reconstruct what happened before approval / pairs with: decision-record-card, approval-rail, tool-call-trace
...
- **Data review table** (data-display / 0.85): data-table, column-header, row-actions, filter-toolbar, pagination
...
- **data-display**: data-table, list, metadata-list, column-header, row-actions, kanban-board, kanban-column, kanban-card / visual signals: Dashboard insight module (0.94), Data review table (0.85)
- **editorial**: editor-canvas, editor-toolbar, slash-command-menu, block-controls, inline-format-menu, content-card, featured-story-card, content-meta / visual signals: Editorial content block (0.94), Review coverage system (0.8)
- **feedback**: filter-chip, badge, inline-alert, empty-state, toast, status-dot, banner, upgrade-banner
...
- **navigation**: sidebar-nav, topbar, breadcrumb, workspace-switcher, scope-switcher, pagination, breadcrumbs, tabs / visual signals: Workspace shell (0.94)
- **workflow**: approval-rail
- **foundation**: app-shell, command-result-item, shortcut-hint, section-header, column-header, row-actions
- **overlay**: inline-format-menu, command-palette, dialog, popover, tooltip, autocomplete, mention-popup, command-result-item
...
:root {
  ...
  --color-anchor-background: #000080;
  --color-depth-support: #003153;
  --color-interface-surface: #0F4C81;
  --color-highlight-air: #D6EAF8;
  --color-proof-accent: #FFBF00;
  ...
  --color-button-danger-text-default: #003153;
  ...
  /* --- Feedback — info --- */
  --color-feedback-info-surface: #F2EFF6;
  --color-feedback-info-text: #967BB6;
  --color-feedback-info-border: #B3A0CA;
  --color-feedback-info-icon: #967BB6;
...
|-----------|-------------|
| activity-card | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Pretendard`, `font:Pretendard` |
| app-shell | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Pretendard`, `font:Pretendard` |
...
| autocomplete | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| byline-row | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| calendar-grid | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| chart-panel | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| command-palette | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| command-result-item | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Pretendard`, `font:Pretendard` |
...
| comparison-table | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| confidence-meter | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| content-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| content-meta | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| context-panel | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| cta-button-group | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| cta-headline | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| cta-section | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| cta-supporting-text | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| customer-logo | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| data-table | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| date-picker | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| date-range-picker | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| faq-answer | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| faq-item | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| faq-question | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| faq-section | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| feature-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| feature-comparison | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| feature-description | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| feature-grid | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| feature-icon | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| feature-section | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| feature-title | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| featured-story-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| file-preview | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| filter-builder | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| filter-chip | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Pretendard`, `font:Pretendard` |
| filter-panel | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| filter-toolbar | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| footer-column | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| footer-legal | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| footer-link | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| footer-social | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| form-actions | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| form-section | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-container | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-cta-group | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-eyebrow | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-headline | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-section | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-subheadline | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-trust-strip | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| hero-visual | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| inline-format-menu | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.none→radius`, `font:Pretendard`, `font:Pretendard` |
| insight-card | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Pretendard`, `font:Pretendard` |
| inspector-drawer | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| logo-cloud | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| metric-highlight | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| metric-strip | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| mobile-menu-trigger | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| policy-matrix | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| popover | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| press-quote | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| pricing-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| ranking-list | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| resizable-split-pane | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| review-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| risk-summary-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| scope-switcher | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| score-badge | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
...
| section-header | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.none→radius`, `font:Pretendard`, `font:Pretendard` |
...
| shortcut-hint | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Pretendard`, `font:Pretendard` |
| sidebar-nav | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| site-footer | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| site-header | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| site-logo | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| site-nav | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| site-nav-cta | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| stat-card | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Pretendard`, `font:Pretendard` |
...
| tab-bar | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| testimonial-author | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| testimonial-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| testimonial-quote | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| testimonial-section | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| time-picker | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| trust-strip | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
| upgrade-banner | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| upload-dropzone | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| upload-progress | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| Navy Blue | Ice Blue | 12.95:1 | AAA (pass) |
| Amber | Ink | 11.42:1 | AAA (pass) |
| Prussian Blue | Ice Blue | 10.86:1 | AAA (pass) |
| Navy Blue | Amber | 9.69:1 | AAA (pass) |
| Classic Blue | Paper | 8.86:1 | AAA (pass) |
| Prussian Blue | Amber | 8.12:1 | AAA (pass) |
| Classic Blue | Ice Blue | 7.16:1 | AAA (pass) |
| Classic Blue | Amber | 5.36:1 | AA (pass) |
| Classic Blue | Ink | 2.13:1 | fail (FAIL) |
| Navy Blue | Classic Blue | 1.81:1 | fail (FAIL) |
| Amber | Paper | 1.65:1 | fail (FAIL) |
| Prussian Blue | Classic Blue | 1.52:1 | fail (FAIL) |
| Prussian Blue | Ink | 1.41:1 | fail (FAIL) |
| Ice Blue | Amber | 1.34:1 | fail (FAIL) |
| Ice Blue | Paper | 1.24:1 | fail (FAIL) |
| Navy Blue | Prussian Blue | 1.19:1 | fail (FAIL) |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | activity-card, breadcrumbs, content-card, decision-record-card, feature-card, featured-story-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | activity-card, breadcrumbs, content-card, decision-record-card, feature-card, featured-story-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Comic panel preview | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Codex image_gen skill | chart-panel, context-panel, filter-panel, hero-trust-strip, metric-strip, tabs | `public/generated/design-system/manifest.json` | no API fallback |
| Comic panel preview sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Openverse, Wikimedia Commons, Unsplash, Pexels | chart-panel, context-panel, filter-panel, hero-trust-strip, metric-strip, tabs | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Editorial cover | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Codex image_gen skill | block-controls, byline-row, comparison-table, content-card, content-meta, editor-canvas | `public/generated/design-system/manifest.json` | no API fallback |
| Editorial cover sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Openverse, Wikimedia Commons, Unsplash, Pexels | block-controls, byline-row, comparison-table, content-card, content-meta, editor-canvas | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
|---------|----------|------------|-------------|
| editorial dashboard ui | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
| editorial-dashboard-split-pane | Local visual references | observed | flows: dashboard; morphology: split-pane |
| landing-hero-serif-trust-strip | Local visual references | observed | flows: dashboard; morphology: split-pane |
| serif product landing page | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| warm premium onboarding flow | Lazyweb MCP real-app corpus | planned | flows: onboarding; morphology: general-interface-composition |
