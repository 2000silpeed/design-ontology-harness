...
- **Expanded supporting colors**:
  ...
  - Fern Green #4F7942 / Natural Greens / reference-color / Fern Green stays inside the preferred families.; Fern Green reinforces the brand mood signals.
...
- **Combination lists**:
  ...
  - Support Spectrum: support=Navy Blue, support=Ochre, support=Classic Blue, support=Forest Green, support=Wheat, support=Fern Green
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=143.0): anchor_surface=Forest Green, structural_support=Bottle Green, quiet_background=Celadon, calm_border=Cascade, fresh_accent=Arcadia
  - ontology-quiet-surface-2 (Quiet Surface, score=93.8): anchor_surface=Bottle Green, structural_support=Moss Green, quiet_background=Forest Green, calm_border=Midnight Violet, fresh_accent=Grape Compote
  - ontology-clear-structure-3 (Clear Structure, score=100.7): anchor_surface=Hunter Green, structural_support=Classic Blue, quiet_background=Bottle Green, calm_border=Mint Green, fresh_accent=Arcadia
  - ontology-strong-signal-4 (Strong Signal, score=93.05): anchor_surface=Moss Green, structural_support=Cascade, quiet_background=Prussian Blue, calm_border=Chili Oil, fresh_accent=Forest Green
  - ontology-cross-family-5 (Cross Family, score=96.95): anchor_surface=Mint Green, structural_support=Moss Green, quiet_background=Celadon, calm_border=Lavender Violet, fresh_accent=Honey Gold
- **Selection rules**:
...
- **Ontology keyword recommendations**:
  - Classic Blue #0F4C81 / blue.pantone_trend / matches 'classic'; matches '안정감'
  - Navy Blue #000080 / blue.deep / matches 'deep'; matches '전문성'
  - Ochre #CC7722 / orange.standard / matches '안정감'; matches '신뢰감'
  - Ochre Yellow #CB9D06 / yellow.deep / matches 'deep'; matches '안정감'
  - Amber #FFBF00 / yellow.standard / matches '안정감'; matches 'low'
...
- **button**: primary-button, secondary-button, icon-button, form-actions, hero-cta-group, add-to-cart-button, wishlist-toggle
- **copilot-artifact**: citation-drawer, source-card
- **data-display**: tag, data-table, column-header, row-actions, metric-strip, status-summary-row, task-surface-header, source-ledger
...
- **overlay**: dialog, popover, tooltip, tooltip-guide, quick-view-modal, command-palette, command-result-item, chart-tooltip
...
|-----------|-------------|
| add-to-cart-button | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| category-pill | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| color-swatch-selector | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| command-result-item | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| cross-sell-grid | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
...
| discount-badge | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| filter-sidebar | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| image-thumbnail | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
...
| original-price-strikethrough | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
...
| price-tag | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
...
| product-card | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| product-detail | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| product-gallery | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| product-grid | `spacing.12→padding`, `radius.none→radius`, `font:Pretendard` |
| product-hero-image | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| quick-view-modal | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| shortcut-hint | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| sidebar-nav | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| size-selector | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| sort-dropdown | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| variant-selector | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| wishlist-toggle | `spacing.8→padding`, `radius.none→radius`, `font:Pretendard` |
...
| Comic panel preview | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Codex image_gen skill | hero-trust-strip, metric-strip, tabs, trust-strip | `public/generated/design-system/manifest.json` | no API fallback |
...
| Editorial cover | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Codex image_gen skill | comparison-table, ranking-list, review-card, score-badge, editorial, marketing | `public/generated/design-system/manifest.json` | no API fallback |
| Editorial cover sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Openverse, Wikimedia Commons, Unsplash, Pexels | comparison-table, ranking-list, review-card, score-badge, editorial, marketing | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
| Hero image | generated | high-fidelity-raster-support; SVG: False | Codex image_gen skill | cta-button-group, feature-comparison, hero-container, hero-cta-group, hero-eyebrow, hero-headline | `public/generated/design-system/manifest.json` | no API fallback |
| Hero image sourced fallback | sourced | high-fidelity-raster-support; SVG: False | Openverse, Wikimedia Commons, Unsplash, Pexels | cta-button-group, feature-comparison, hero-container, hero-cta-group, hero-eyebrow, hero-headline | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
