...
- **Expanded semantic roles**:
  ...
  - `ink_muted` -> Fern Green #4F7942 / Natural Greens
...
- **Combination lists**:
  ...
  - Surface System: canvas=Canvas White, surface=Paper, border=Border Neutral, ink=Ink, ink_muted=Fern Green
  - Support Spectrum: support=Ochre, support=Navy Blue, support=Sky Blue, support=Ocean Blue, support=Classic Blue, support=Forest Green
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=121.75): anchor_surface=Forest Green, structural_support=Bottle Green, quiet_background=Celadon, calm_border=Cascade, fresh_accent=Arcadia
  - ontology-quiet-surface-2 (Quiet Surface, score=78.65): anchor_surface=Moss Green, structural_support=Forest Green, quiet_background=Chili Oil, calm_border=Periwinkle, fresh_accent=Illuminating
  - ontology-clear-structure-3 (Clear Structure, score=80.95): anchor_surface=Bottle Green, structural_support=Cascade, quiet_background=Grape Compote, calm_border=Hunter Green, fresh_accent=Arcadia
  - ontology-strong-signal-4 (Strong Signal, score=82.0): anchor_surface=Bottle Green, structural_support=Olive Green, quiet_background=Prussian Blue, calm_border=Cascade, fresh_accent=Forest Green
  - ontology-cross-family-5 (Cross Family, score=70.45): anchor_surface=Celadon, structural_support=Aubergine, quiet_background=Chili Oil, calm_border=Ice Blue, fresh_accent=Lemon Yellow
- **Selection rules**:
...
- **Ontology keyword recommendations**:
  - Navy Blue #000080 / blue.deep / matches 'low'; matches '전문성'
  - Moss Green #8A9A5B / green.natural / matches 'low'; matches '차분함'
  - Ice Blue #D6EAF8 / blue.pastel / matches 'low'; matches '정제됨'
  - Lavender Mist #E6E6FA / violet.pastel / matches 'low'; matches '차분함'
  - Misty Blue #B5C7EB / blue.pastel / matches 'low'; matches '차분함'
...
- **Density**: dense (confidence 0.38, provenance inferred) / dashboard x0.45, table x2.25
- **Surface Style**: flat (confidence 0.24, provenance inferred) / flat x0.8, minimal x0.45, clean x0.75
- **Corner Style**: medium (confidence 0.15, provenance inferred) / card x0.9
- **Typography Mood**: utilitarian (confidence 0.22, provenance inferred) / dashboard x0.45, table x2.25
- **Color balance**: temperature=unknown, contrast=unknown, neutral_bias=unknown, provenance=unverified

### Layout Rhythm

- **Data review surface**: confidence 0.52 / provenance inferred / table x2.25, grid x0.9, data x1.8, filter x0.9
- **Split-pane workspace**: confidence 0.48 / provenance inferred / workspace x0.9, sidebar x1.8, app x0.9, navigation x0.9
- **Dashboard grid**: confidence 0.36 / provenance inferred / dashboard x0.45, kpi x0.9, table x2.25
...
- **Context cards**:
  - `research-query-01` (research-query, planned): minimal saas dashboard / flows: dashboard / morphology: general-interface-composition
  - `research-query-02` (research-query, planned): linear.app data table / flows: data-review / morphology: dense-table
  - `research-query-03` (research-query, planned): notion command palette / flows: general-product-ui / morphology: composer
  - `research-query-04` (research-query, planned): height.app issue list / flows: general-product-ui / morphology: general-interface-composition
- **Research gaps**:
...
- **Required families**: button, data-display, document, editorial, feedback, input, layout, navigation, foundation, overlay
...
- **resizable-split-pane** (layout, score 4): primary work happens between list, canvas/chat, and detail panels; users need to compare or inspect adjacent information without navigation / pairs with: thread-list, artifact-preview-panel, inspector-drawer
...
- **Dashboard insight module** (data-display / 0.32): metric-strip, status-summary-row, chart-panel, section-header, filter-chip
...
- **feedback**: badge, inline-alert, empty-state, toast, status-dot, banner, shortcut-hint, status-badge
...
- **navigation**: scope-switcher, breadcrumbs, tabs, pagination, operational-rail, app-shell, sidebar-nav, topbar
- **foundation**: command-result-item, shortcut-hint
- **overlay**: command-palette, dialog, popover, tooltip, autocomplete, command-result-item, user-menu, confirm-dialog
...
:root {
  ...
  --color-button-ghost-text-default: #4F7942;
  --color-button-ghost-text-hover: #111111;
  --color-button-ghost-text-disabled: #ABBFA7;
  ...
  --color-input-text-placeholder: #92AC8C;
  --color-input-text-disabled: #ABBFA7;
  ...
  /* --- Nav link --- */
  --color-nav-link-text-default: #4F7942;
  ...
  --color-link-text-visited: #4F7942;
...
|-----------|-------------|
| activity-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
| block-controls | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
...
| column-header | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
...
| comment-input | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| comment-thread | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
...
| editor-canvas | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| editor-toolbar | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
...
| filter-chip | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
| inline-format-menu | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| insight-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
| mention-popup | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
| redline-viewer | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| resizable-split-pane | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| row-actions | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
...
| section-header | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
...
| slash-command-menu | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| source-ledger | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| stat-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | activity-card, breadcrumbs, insight-card, kanban-card, pricing-card, profile-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | activity-card, breadcrumbs, insight-card, kanban-card, pricing-card, profile-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
|---------|----------|------------|-------------|
| height.app issue list | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| linear.app data table | Lazyweb MCP real-app corpus | planned | flows: data-review; morphology: dense-table |
| minimal saas dashboard | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
| notion command palette | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: composer |
