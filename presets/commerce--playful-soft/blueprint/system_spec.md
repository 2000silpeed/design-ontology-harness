...
- **Heading note**: rounded sans, playful-soft 시각 성격 핵심 — page-title / product-title / section-header / kpi-label / add-to-cart pill, serif/geometric impact 금지
- **Body note**: product description / review / cart line / checkout field / filter chip 공용 본문, line-height 1.5–1.6 (commerce soft)
...
- **Loading**: Inter(preload), Quicksand(preload), Pretendard(preload), JetBrains Mono(lazy) | display: swap
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=130.8): masthead_energy=Pure Red, cover_signal=Scarlet, paper_field=Buttercream, feature_frame=Ultra Violet, attention_flash=Illuminating
  - ontology-quiet-surface-2 (Quiet Surface, score=74.2): masthead_energy=Scarlet, cover_signal=Lemon Yellow, paper_field=Salmon, feature_frame=Creamsicle, attention_flash=Persimmon
  - ontology-clear-structure-3 (Clear Structure, score=78.0): masthead_energy=Scarlet, cover_signal=Pure Orange, paper_field=Salmon, feature_frame=Royal Purple, attention_flash=Illuminating
  - ontology-strong-signal-4 (Strong Signal, score=81.7): masthead_energy=Ruby, cover_signal=Tangerine, paper_field=Naples Yellow, feature_frame=Ultra Violet, attention_flash=Lemon Yellow
  - ontology-cross-family-5 (Cross Family, score=89.1): masthead_energy=Grenadine, cover_signal=Royal Purple, paper_field=Buttercream, feature_frame=Creamsicle, attention_flash=Lemon Yellow
- **Selection rules**:
...
- **Ontology keyword recommendations**:
  ...
  - Creamsicle #FFD7A0 / orange.pastel / matches 'orange'; matches 'pastel'
  - Peach Puff #FFDAB9 / orange.pastel / matches 'orange'; matches 'pastel'
  - Buttercream #F3E5AB / yellow.pastel / matches 'pastel'; matches 'cream'
  - Apricot #FFB27F / orange.natural / matches 'orange'; matches '자연스러움'
...
- **Density**: balanced (confidence 0.29, provenance inferred) / product x5.45
- **Surface Style**: tinted (confidence 0.44, provenance inferred) / warm x3.3, editorial x0.25, cream x1.7000000000000002
- **Corner Style**: round (confidence 0.48, provenance inferred) / rounded x7.050000000000001, soft x6.15
- **Typography Mood**: playful (confidence 0.28, provenance inferred) / playful x0.95, friendly x3.2
- **Color balance**: temperature=unknown, contrast=unknown, neutral_bias=unknown, provenance=unverified

### Layout Rhythm

- **Data review surface**: confidence 0.45 / provenance inferred / table x0.15, grid x2.1, data x0.15, review x3.0500000000000003
- **Editorial feed**: confidence 0.37 / provenance inferred / editorial x0.25, feed x0.45, magazine x0.25, review x3.0500000000000003
...
- **Context cards**:
  - `research-query-01` (research-query, planned): olipop d2c soda ecommerce / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-02` (research-query, planned): magic spoon cereal shop / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-03` (research-query, planned): poppi prebiotic soda store / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-04` (research-query, planned): graza olive oil craft d2c / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-05` (research-query, planned): caraway cookware warm pastel shop / flows: general-product-ui / morphology: general-interface-composition
- **Research gaps**:
...
- **Required families**: button, data-display, document, feedback, input, marketing, navigation, commerce, dashboard-growth, dashboard-wellness, overlay, social
...
- **redline-viewer** (document, score 2): legal, compliance, or editorial text needs reviewer markup; comments must stay anchored to exact text ranges / pairs with: diff-viewer, comment-thread, approval-rail
...
- **Data review table** (data-display / 0.34): data-table, column-header, row-actions, filter-toolbar, pagination

- **button**: primary-button, secondary-button, icon-button, form-actions, add-to-cart-button, wishlist-toggle, follow-button, hero-cta-group
- **data-display**: tag, pricing-card, feature-comparison, search-results, tag-pill, metric-strip, status-summary-row, task-surface-header
- **document**: redline-viewer
- **feedback**: badge, inline-alert, empty-state, toast, status-dot, status-badge, upgrade-banner, discount-badge
- **input**: text-field, select, checkbox, switch, segmented-control, textarea, radio-group, form-section
- **marketing**: hero-container, hero-eyebrow, hero-headline, hero-subheadline, hero-visual, hero-trust-strip
- **navigation**: breadcrumbs, tabs, pagination, category-pill, operational-rail, wizard-layout, filter-bar, app-shell
...
- **overlay**: dialog, popover, tooltip, quick-view-modal, autocomplete, confirm-dialog, share-sheet, soft-dialog
...
| add-to-cart-button | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| address-form | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| alert-list | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| app-shell | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| autocomplete | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| avatar | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| avatar-cluster | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| badge | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| banner | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumb | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumbs | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| cart-drawer | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| cart-item | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| cart-summary | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| category-pill | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chat-input | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| checkbox | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| checkout-step | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| checkout-step-progress | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chip | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| cohort-matrix | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| color-swatch-selector | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| column-header | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| confirm-dialog | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| dashboard-card | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| data-table | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| dialog | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| discount-badge | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| empty-cart-state | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| empty-feed-illustration | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| empty-state | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| evidence-graph | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| experiment-panel | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| filter-bar | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-chip | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-panel | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-sidebar | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| follow-button | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-actions | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-section | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| gentle-toast | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| hero-container | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-cta-group | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-eyebrow | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-headline | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-subheadline | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-trust-strip | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-visual | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| icon-button | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| image-thumbnail | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| inline-alert | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| inspector-drawer | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| kanban-board | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| kanban-card | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| mood-chart | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| mood-check | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| operational-rail | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
...
| pagination | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| payment-form | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| popover | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| post-card | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| price-tag | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| pricing-card | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| primary-button | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| product-card | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| product-hero-image | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| profile-card | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| promo-code-input | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| quantity-stepper | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| quick-view-modal | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| radio-group | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| reply-composer | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| retention-chart | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| row-actions | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| saved-view-bar | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-field | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-results | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| secondary-button | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| section-header | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| segment-filter | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| segmented-control | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| select | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| share-sheet | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| sidebar-nav | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| size-selector | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| soft-dialog | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| sort-dropdown | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| source-ledger | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| status-badge | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-dot | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-summary-row | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| step-progress | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| streak-indicator | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| switch | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tab-bar | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tabs | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| text-field | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| textarea | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| toast | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip-guide | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| topbar | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| upgrade-banner | `color.Blanched Almond→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| user-list | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| user-menu | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| variant-selector | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| wellness-score | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| wishlist-toggle | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| wizard-layout | `color.Rose Quartz→surface`, `color.Dark Salmon→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | add-to-cart-button, breadcrumbs, category-pill, color-swatch-selector, cross-sell-grid, dashboard-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | add-to-cart-button, breadcrumbs, category-pill, color-swatch-selector, cross-sell-grid, dashboard-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
| Hero image | generated | high-fidelity-raster-support; SVG: False | Codex image_gen skill | feature-comparison, hero-container, hero-cta-group, hero-eyebrow, hero-headline, hero-subheadline | `public/generated/design-system/manifest.json` | no API fallback |
| Hero image sourced fallback | sourced | high-fidelity-raster-support; SVG: False | Openverse, Wikimedia Commons, Unsplash, Pexels | feature-comparison, hero-container, hero-cta-group, hero-eyebrow, hero-headline, hero-subheadline | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
|---------|----------|------------|-------------|
| caraway cookware warm pastel shop | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| graza olive oil craft d2c | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| magic spoon cereal shop | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| olipop d2c soda ecommerce | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| poppi prebiotic soda store | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
