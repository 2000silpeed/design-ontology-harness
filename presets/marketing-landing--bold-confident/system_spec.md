...
- **Active roles**:
  ...
  - `proof_accent` -> Pure Red #FF0000 / red.standard
- **Selected colors**:
  ...
  - Pure Red #FF0000 / red.standard / 열정, 에너지, 주목성, 상징적, 강렬함
...
- **Expanded supporting colors**:
  - Electric Green #00FF85 / Accent Brights / reference-color / Electric Green reinforces the brand mood signals.
  - Matchday Red #E90052 / Deep Reds / reference-color / Matchday Red stays inside the preferred families.; Matchday Red reinforces the brand mood signals.
  - Golden Score #FFD700 / Accent Brights / reference-color / Golden Score reinforces the brand mood signals.
  ...
  - Midnight Navy #1A1A2E / Deep Neutrals / reference-color / Midnight Navy stays inside the preferred families.; Midnight Navy reinforces the brand mood signals.
  - Premier Purple #38003C / Deep Reds / reference-color / Premier Purple stays inside the preferred families.; Premier Purple reinforces the brand mood signals.
...
- **Expanded semantic roles**:
  ...
  - `ink_muted` -> Steel Gray #4A4A5E / Deep Neutrals
  - `ink_subtle` -> Draw Gray #78909C / Semantic States
  - `ink_inverse` -> Ink Inverse #FFFFFF / Generated Fallback
- **Combination lists**:
  - Seed Core: anchor_background=Navy Blue, depth_support=Prussian Blue, interface_surface=Classic Blue, highlight_air=Ice Blue, proof_accent=Pure Red
  - Surface System: canvas=Canvas White, surface=Paper, border=Border Neutral, ink=Midnight Navy, ink_muted=Steel Gray
  - Support Spectrum: support=Electric Green, support=Matchday Red, support=Golden Score, support=Caution Amber, support=Victory Green, support=Midnight Navy
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=145.28): anchor_background=Navy Blue, depth_support=Prussian Blue, interface_surface=Classic Blue, highlight_air=Ice Blue, proof_accent=Pure Red
  - ontology-quiet-surface-2 (Quiet Surface, score=95.22): anchor_background=Classic Blue, depth_support=Navy Blue, interface_surface=Kelly Green, highlight_air=Ocean Blue, proof_accent=Royal Purple
  - ontology-clear-structure-3 (Clear Structure, score=95.92): anchor_background=Prussian Blue, depth_support=Forest Green, interface_surface=Kelly Green, highlight_air=Teal Blue, proof_accent=Pure Red
  - ontology-strong-signal-4 (Strong Signal, score=107.53): anchor_background=Crimson, depth_support=Navy Blue, interface_surface=Lemon Yellow, highlight_air=Ice Blue, proof_accent=Ruby
  - ontology-cross-family-5 (Cross Family, score=106.93): anchor_background=Crimson, depth_support=Forest Green, interface_surface=Classic Blue, highlight_air=Azure Blue, proof_accent=Scarlet
- **Selection rules**:
...
- **Matched color keywords**:
  ...
  - `proof_accent` -> Pure Red #FF0000 / red.standard / mood=열정, 에너지, 주목성 / axes=mid_value, high_chroma
- **Ontology keyword recommendations**:
  ...
  - Kelly Green #4CBB17 / green.standard / matches 'standard'; matches 'tags'
  - Ruby #E11F51 / red.standard / matches 'standard'; matches 'tags'
  - Scarlet #FF2400 / red.standard / matches 'standard'; matches 'tags'
...
- No design context pack generated. Connect visual_reference sources or provider plans to ground reference research.
...
- **Required families**: button, data-display, feedback, input, layout, marketing, navigation, workflow, foundation, overlay, surface
...
- **command-palette** (overlay, score 8): the product has many actions or navigation targets; expert users benefit from quick action search / pairs with: shortcut-hint, saved-view-bar, filter-builder
...
- **button**: primary-button, secondary-button, icon-button, form-actions, hero-cta-group
- **data-display**: data-table, list, metadata-list, column-header, row-actions, search-results, metric-strip, status-summary-row
- **feedback**: filter-chip, badge, inline-alert, empty-state, toast, status-dot, status-badge, confidence-meter
- **input**: text-field, select, checkbox, switch, segmented-control, filter-chip, search-field, filter-panel
...
- **foundation**: section-header, column-header, row-actions, app-shell
- **overlay**: dialog, popover, tooltip, autocomplete, chart-tooltip, user-menu, command-palette, inspector-drawer
...
:root {
  ...
  --color-button-ghost-text-disabled: #A9AAB4;
  --color-button-ghost-border-default: transparent;
  --color-button-ghost-focus-ring: #1A1A2E;
  ...
  --color-input-text-placeholder: #8F909C;
  --color-input-text-disabled: #A9AAB4;
  --color-input-border-default: #D6DDE6;
  --color-input-border-hover: #B6C3D3;
  --color-input-border-focus: #1A1A2E;
  ...
  --color-card-border-focus: #1A1A2E;

  /* --- Nav link --- */
  --color-nav-link-text-default: #4A4A5E;
  --color-nav-link-text-hover: #1A1A2E;
  --color-nav-link-text-active: #1A1A2E;
  --color-nav-link-surface-hover: #F6F6F7;
  --color-nav-link-indicator: #1A1A2E;

  /* --- Link --- */
  --color-link-text-default: #1A1A2E;
  --color-link-text-hover: #1A1A2E;
  --color-link-text-visited: #4A4A5E;

  /* --- Feedback — info --- */
  --color-feedback-info-surface: #E4E4E6;
  --color-feedback-info-text: #1A1A2E;
  --color-feedback-info-border: #5C5D6B;
  --color-feedback-info-icon: #1A1A2E;

  /* --- Feedback — success --- */
  --color-feedback-success-surface: #E0FFF0;
  --color-feedback-success-text: #00FF85;
  --color-feedback-success-border: #4AFDA8;
  --color-feedback-success-icon: #00FF85;

  /* --- Feedback — warning --- */
  --color-feedback-warning-surface: #FFFAE0;
  --color-feedback-warning-text: #FFD700;
  --color-feedback-warning-border: #FDE14B;
  --color-feedback-warning-icon: #FFD700;

  /* --- Feedback — danger --- */
  --color-feedback-danger-surface: #FCE0EA;
  --color-feedback-danger-text: #E90052;
  --color-feedback-danger-border: #ED4A84;
...
| app-shell | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| approval-rail | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
...
| chart-container | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| chart-legend | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| chart-tooltip | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
| workspace-switcher | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
| Pure Red | Ink | 4.72:1 | AA (pass) |
| Pure Red | Paper | 4.00:1 | AA-large (large-only) |
| Navy Blue | Pure Red | 4.00:1 | AA-large (large-only) |
| Prussian Blue | Pure Red | 3.36:1 | AA-large (large-only) |
| Ice Blue | Pure Red | 3.23:1 | AA-large (large-only) |
| Classic Blue | Pure Red | 2.22:1 | fail (FAIL) |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | activity-card, breadcrumbs, decision-record-card, insight-card, kanban-card, profile-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | activity-card, breadcrumbs, decision-record-card, insight-card, kanban-card, profile-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
No reference intelligence pack defined.
