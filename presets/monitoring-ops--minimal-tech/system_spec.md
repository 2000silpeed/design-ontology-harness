...
- **Heading note**: geometric sans, 숫자/영문 가독성
- **Body note**: UI 라벨/본문 공용
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=132.75): anchor_surface=Forest Green, structural_support=Bottle Green, quiet_background=Celadon, calm_border=Cascade, fresh_accent=Arcadia
  - ontology-quiet-surface-2 (Quiet Surface, score=93.15): anchor_surface=Mint Green, structural_support=Cascade, quiet_background=Coral Blush, calm_border=Apricot, fresh_accent=Super Sonic
  - ontology-clear-structure-3 (Clear Structure, score=96.95): anchor_surface=Bottle Green, structural_support=Moss Green, quiet_background=Grape Compote, calm_border=Peach Puff, fresh_accent=Arcadia
  - ontology-strong-signal-4 (Strong Signal, score=87.75): anchor_surface=Cascade, structural_support=Chili Oil, quiet_background=Midnight Violet, calm_border=Ice Blue, fresh_accent=Blue Atoll
  - ontology-cross-family-5 (Cross Family, score=93.95): anchor_surface=Cascade, structural_support=Hunter Green, quiet_background=Celadon, calm_border=Coral Blush, fresh_accent=Azure Blue
- **Selection rules**:
...
- **Matched color keywords**:
  - `primary` -> Azure Blue #007FFF / blue.standard / mood=개방감, 에너지, 명료함 / axes=high_value, high_chroma, cool_bias
  - `accent` -> Emerald Green #50C878 / green.standard / mood=고급스러움, 생명력, 세련된 안정감 / axes=mid_value, mid_chroma
  - `surface_tint` -> Ice Blue #D6EAF8 / blue.pastel / mood=정제됨, 청결함, 섬세함 / axes=high_value, low_chroma, cool_bias
- **Ontology keyword recommendations**:
  - Creamsicle #FFD7A0 / orange.pastel / matches 'low_chroma'; matches 'pastel'
  - Mint Green #98FF98 / green.pastel / matches 'low_chroma'; matches 'pastel'
  - Apricot #FFB27F / orange.natural / matches 'low_chroma'; matches '자연스러움'
  - Peach Puff #FFDAB9 / orange.pastel / matches 'low_chroma'; matches 'pastel'
  - Blue Atoll #00B1D2 / blue.pantone_trend / matches 'cool'; matches 'high'
...
- **Density**: dense (confidence 0.5, provenance inferred) / dashboard x0.45, table x2.6, monitoring x1.2
...
- **Typography Mood**: utilitarian (confidence 0.23, provenance inferred) / dashboard x0.45, table x2.6
- **Color balance**: temperature=unknown, contrast=unknown, neutral_bias=unknown, provenance=unverified

### Layout Rhythm

- **Dashboard grid**: confidence 0.52 / provenance inferred / dashboard x0.45, metric x2.55, kpi x0.9, chart x2.6
- **Data review surface**: confidence 0.52 / provenance inferred / table x2.6, grid x2.6, log x0.9, filter x0.9
- **Split-pane workspace**: confidence 0.3 / provenance inferred / sidebar x0.9, editor x0.9, navigation x0.9
...
- **Context cards**:
  - `research-query-01` (research-query, planned): grafana dashboard dark / flows: dashboard / morphology: general-interface-composition
  - `research-query-02` (research-query, planned): datadog monitoring console / flows: dashboard / morphology: general-interface-composition
  - `research-query-03` (research-query, planned): honeycomb observability traces / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-04` (research-query, planned): prometheus alert list / flows: general-product-ui / morphology: general-interface-composition
- **Research gaps**:
...
- **Required families**: button, copilot-chat, data-display, feedback, input, navigation, dashboard-growth, overlay
...
- **saved-view-bar** (navigation, score 12): teams revisit the same filtered views often; dense tools need stable scope memory / pairs with: filter-builder, bulk-action-table, exception-queue
- **audit-timeline** (data-display, score 10): regulated workflows require traceable user and AI actions; reviewers need to reconstruct what happened before approval / pairs with: decision-record-card, approval-rail, tool-call-trace
...
- **evidence-graph** (data-display, score 8): trust depends on seeing relationships between claims and sources; auditors need to trace why an answer or decision was made / pairs with: citation-drawer, decision-record-card, policy-matrix
...
- **tool-call-trace** (copilot-chat, score 8): AI actions need explainability or debugging; operators need to audit retrieval, policy checks, or workflow calls / pairs with: audit-timeline, citation-drawer, decision-record-card
- **bulk-action-table** (data-display, score 6): users handle many records at once; selection count and destructive actions must stay visible / pairs with: saved-view-bar, filter-builder, exception-queue
...
- **Workspace shell** (navigation / 0.33): app-shell, sidebar-nav, workspace-switcher, breadcrumb, context-panel

- **button**: primary-button, secondary-button, icon-button, form-actions
- **copilot-chat**: tool-call-trace
- **data-display**: metric-strip, status-summary-row, task-surface-header, source-ledger, section-header, chart-container, chart-legend, data-table
- **feedback**: badge, inline-alert, empty-state, toast, status-dot, banner, status-badge, step-progress
...
- **overlay**: dialog, popover, tooltip, chart-tooltip, autocomplete, confirm-dialog, tooltip-guide, command-palette
...
| activity-card | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| alert-list | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| app-shell | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| audit-timeline | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| autocomplete | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| badge | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| banner | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumb | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumbs | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| chart-container | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-legend | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-tooltip | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| checkbox | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chip | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| command-palette | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| confidence-meter | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| confirm-dialog | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| date-picker | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| date-range-picker | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| decision-record-card | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| dialog | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| empty-state | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| experiment-panel | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-bar | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-builder | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-chip | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-panel | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-actions | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-section | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| goal-tracker | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| icon-button | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| inline-alert | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| insight-card | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| inspector-drawer | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| kanban-board | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| kanban-card | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| operational-rail | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| pagination | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| popover | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| primary-button | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| radio-group | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| referral-widget | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| retention-chart | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| risk-summary-card | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| row-actions | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| saved-view-bar | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-field | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-results | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| secondary-button | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| section-header | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| segment-filter | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| segmented-control | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| select | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| sidebar-nav | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| source-ledger | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| stat-card | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-badge | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-dot | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-summary-row | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| step-progress | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| switch | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tab-bar | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tabs | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tag | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| task-surface-header | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| text-field | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| textarea | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| ticket-queue | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| time-picker | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| toast | `color.Ice Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tool-call-trace | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| tooltip | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip-guide | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| topbar | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| user-list | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| wizard-layout | `color.Azure Blue→surface`, `color.Emerald Green→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | activity-card, breadcrumbs, decision-record-card, insight-card, kanban-card, risk-summary-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | activity-card, breadcrumbs, decision-record-card, insight-card, kanban-card, risk-summary-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Comic panel preview | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Codex image_gen skill | experiment-panel, filter-panel, metric-strip, tabs | `public/generated/design-system/manifest.json` | no API fallback |
| Comic panel preview sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Openverse, Wikimedia Commons, Unsplash, Pexels | experiment-panel, filter-panel, metric-strip, tabs | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
|---------|----------|------------|-------------|
| datadog monitoring console | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
| grafana dashboard dark | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
| honeycomb observability traces | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| prometheus alert list | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
