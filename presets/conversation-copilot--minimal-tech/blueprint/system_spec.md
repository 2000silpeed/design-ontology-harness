...
- **Hangul display safety**: line-height >= 1.02 | tracking -0.03em to 0em | forced <br /> 금지 until breakpoint QA
...
- **Expanded supporting colors**:
  ...
  - Cerulean #2A52BE / Standard Blues / reference-color / Cerulean stays inside the preferred families.; Cerulean reinforces the brand mood signals.
  ...
  - Prussian Blue #003153 / Deep Blues / reference-color / Prussian Blue stays inside the preferred families.
- **Expanded semantic roles**:
  ...
  - `ink` -> Prussian Blue #003153 / Deep Blues
...
- **Combination lists**:
  ...
  - Surface System: canvas=Canvas White, surface=Paper, border=Border Neutral, ink=Prussian Blue, ink_muted=Muted Ink
  - Support Spectrum: support=Navy Blue, support=Ochre, support=Sky Blue, support=Classic Blue, support=Forest Green, support=Cerulean
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=153.75): anchor_surface=Forest Green, structural_support=Bottle Green, quiet_background=Celadon, calm_border=Cascade, fresh_accent=Arcadia
  - ontology-quiet-surface-2 (Quiet Surface, score=102.55): anchor_surface=Bottle Green, structural_support=Forest Green, quiet_background=Prussian Blue, calm_border=Moss Green, fresh_accent=Grape Compote
  - ontology-clear-structure-3 (Clear Structure, score=109.35): anchor_surface=Hunter Green, structural_support=Navy Blue, quiet_background=Prussian Blue, calm_border=Grape Compote, fresh_accent=Arcadia
  - ontology-strong-signal-4 (Strong Signal, score=112.6): anchor_surface=Moss Green, structural_support=Navy Blue, quiet_background=Midnight Violet, calm_border=Cascade, fresh_accent=Forest Green
  - ontology-cross-family-5 (Cross Family, score=93.35): anchor_surface=Celadon, structural_support=Mint Green, quiet_background=Prussian Blue, calm_border=Lavender Violet, fresh_accent=Illuminating
- **Selection rules**:
...
- **Ontology keyword recommendations**:
  - Navy Blue #000080 / blue.deep / matches 'chroma'; matches 'low'
  - Midnight Violet #2E1A47 / violet.deep / matches 'low_chroma'; matches 'chroma'
  - Prussian Blue #003153 / blue.deep / matches 'low_chroma'; matches 'chroma'
  - Chili Oil #944537 / orange.pantone_trend / matches 'low_chroma'; matches 'chroma'
  - Flax #EEDC82 / yellow.natural / matches 'low_chroma'; matches 'chroma'
...
- **Density**: dense (confidence 0.94, provenance inferred) / dashboard x4.3500000000000005, table x3.45, ops x1.5
- **Surface Style**: flat (confidence 0.62, provenance inferred) / minimal x4.2
- **Corner Style**: pill (confidence 0.39, provenance inferred) / svg corner ratio 0.50
- **Typography Mood**: utilitarian (confidence 0.94, provenance inferred) / dashboard x4.3500000000000005, enterprise x0.65, ops x1.5
- **Color balance**: temperature=cool, contrast=high, neutral_bias=low, provenance=observed / dominant #0B1623, #22354B, #29435C

### Layout Rhythm

- **Dashboard grid**: confidence 0.94 / provenance inferred / dashboard x4.3500000000000005, table x3.45, ops x1.5, 3:2-ish x2
- **Data review surface**: confidence 0.94 / provenance inferred / table x3.45, grid x2.4, audit x5.250000000000001, log x2.85
- **Narrative landing flow**: confidence 0.94 / provenance inferred / landing x1.35, hero x0.9, pricing x0.9, testimonial x0.9
- **Split-pane workspace**: confidence 0.4 / provenance inferred / command x0.9, 3:2-ish x2

### Image-derived Component Hints

- **Cards**: flat card planes를 기본으로 하고, 압축된 spacing과 얇은 divider 중심의 hierarchy. pill-like actions만 제한적으로 허용. / provenance inferred / surface=flat, density=dense, corner=pill
...
- **Providers**:
  ...
  - `pinterest`: active / manual-or-playwright-capture / search assist and shortlist support
  - `lazyweb`: suggested / mcp-or-manual-export / real app flow and screen corpus provider
- **Flow coverage**:
  - dashboard: covered (3 context cards; lazyweb, local-images)
  - data-review: covered (3 context cards; lazyweb, local-images)
  - general-product-ui: covered (1 context cards; lazyweb)
  - pricing: gap (0 context cards; no selected provider evidence)
- **Context cards**:
  - `source-01-image-01` (visual-screen, observed): audit-log-dense-table / flows: data-review, dashboard / morphology: dense-table, timeline
  - `source-01-image-02` (visual-screen, observed): ops-dashboard-verified-grid / flows: data-review, dashboard / morphology: dense-table, timeline
  - `research-query-01` (research-query, planned): technical archive dashboard ui / flows: dashboard / morphology: general-interface-composition
  - `research-query-02` (research-query, planned): dense audit log table interface / flows: data-review / morphology: dense-table, timeline
  - `research-query-03` (research-query, planned): minimal enterprise landing page / flows: general-product-ui / morphology: general-interface-composition
- **Research gaps**:
...
- **Required families**: button, data-display, editorial, feedback, input, layout, marketing, navigation, foundation, overlay, surface
...
- **audit-timeline** (data-display, score 12): regulated workflows require traceable user and AI actions; reviewers need to reconstruct what happened before approval / pairs with: decision-record-card, approval-rail, tool-call-trace
- **bulk-action-table** (data-display, score 12): users handle many records at once; selection count and destructive actions must stay visible / pairs with: saved-view-bar, filter-builder, exception-queue
- **decision-record-card** (data-display, score 10): a reviewer or AI-assisted workflow reaches a durable decision; regulated teams need record ids and retention status / pairs with: audit-timeline, approval-rail, citation-drawer
- **exception-queue** (data-display, score 10): multiple issues require triage, assignment, and resolution; reviewers need to batch handle exceptions / pairs with: bulk-action-table, policy-matrix, approval-rail
...
- **risk-summary-card** (data-display, score 10): users need a fast read of risk before drilling into policy details; AI confidence or compliance severity must be visible / pairs with: policy-matrix, confidence-meter, exception-queue
...
- **confidence-meter** (feedback, score 8): AI or policy outcome includes uncertainty; users must decide whether to trust, edit, or escalate / pairs with: risk-summary-card, policy-matrix, tool-call-trace

- **Visual-reference archetypes**:

- **Dashboard insight module** (data-display / 0.94): metric-strip, status-summary-row, chart-panel, section-header, filter-chip
...
- **Review coverage system** (editorial / 0.8): review-card, score-badge, comparison-table, ranking-list, filter-chip

- **button**: primary-button, secondary-button, icon-button, form-actions, hero-cta-group, cta-button-group, site-nav-cta, mobile-menu-trigger
- **data-display**: data-table, list, metadata-list, column-header, row-actions, pricing-card, feature-comparison, kanban-board / visual signals: Dashboard insight module (0.94), Data review table (0.94)
- **editorial**: review-card, score-badge, comparison-table, ranking-list / visual signals: Review coverage system (0.8)
- **feedback**: filter-chip, badge, inline-alert, empty-state, toast, status-dot, upgrade-banner, status-badge
...
- **navigation**: pagination, scope-switcher, breadcrumbs, tabs, wizard-layout, app-shell, sidebar-nav, topbar
- **foundation**: column-header, row-actions, command-result-item, shortcut-hint, section-header
- **overlay**: command-palette, dialog, popover, tooltip, autocomplete, tooltip-guide, user-menu, confirm-dialog
- **surface**: stat-card, insight-card, activity-card
...
:root {
  ...
  --color-button-secondary-surface-hover: #F0F3F5;
  --color-button-secondary-surface-active: #E6EAEE;
  --color-button-secondary-surface-disabled: #F7F8FA;
  --color-button-secondary-text-default: #003153;
  --color-button-secondary-text-disabled: #889EAF;
  ...
  --color-button-ghost-surface-hover: #F2F5F6;
  --color-button-ghost-surface-active: #E8ECF0;
  --color-button-ghost-surface-disabled: transparent;
  --color-button-ghost-text-default: #4B5563;
  --color-button-ghost-text-hover: #003153;
  ...
  --color-input-text-default: #003153;
  ...
  --color-card-surface-hover: #FAFBFC;
  ...
  --color-nav-link-text-hover: #003153;
  --color-nav-link-text-active: #003153;
  --color-nav-link-surface-hover: #F5F7F8;
  --color-nav-link-indicator: #003153;

  /* --- Link --- */
  --color-link-text-default: #003153;
  --color-link-text-hover: #003153;
...
|-----------|-------------|
| activity-card | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| app-shell | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| audit-timeline | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| autocomplete | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| avatar | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| badge | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| banner | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| breadcrumb | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| breadcrumbs | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| bulk-action-table | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| calendar-grid | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| chart-panel | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| checkbox | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| chip | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| column-header | `spacing.8→padding`, `radius.none→radius`, `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| command-palette | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| command-result-item | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| comparison-table | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| confidence-meter | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| confirm-dialog | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| cta-button-group | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| cta-headline | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| cta-section | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| cta-supporting-text | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| customer-logo | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| data-table | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| date-picker | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| date-range-picker | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| decision-record-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| dialog | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| empty-state | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| evidence-graph | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| exception-queue | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| faq-answer | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| faq-item | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| faq-question | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| faq-section | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| feature-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| feature-comparison | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| feature-description | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| feature-grid | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| feature-icon | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| feature-section | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| feature-title | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| filter-builder | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| filter-chip | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| filter-panel | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| filter-toolbar | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| footer-column | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| footer-legal | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| footer-link | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| footer-social | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| form-actions | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| form-section | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-container | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-cta-group | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-eyebrow | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-headline | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-section | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-subheadline | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-trust-strip | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| hero-visual | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| icon-button | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| inline-alert | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| insight-card | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| inspector-drawer | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| kanban-board | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| kanban-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| kanban-column | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| list | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| logo-cloud | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| metadata-list | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| metric-highlight | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| metric-strip | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| mobile-menu-trigger | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| operational-rail | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| pagination | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| policy-matrix | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| popover | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| press-quote | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| pricing-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| primary-button | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| profile-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| radio-group | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| ranking-list | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| resizable-split-pane | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| review-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| risk-summary-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| row-actions | `spacing.8→padding`, `radius.none→radius`, `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| saved-view-bar | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| scope-switcher | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| score-badge | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| search-field | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| search-results | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| secondary-button | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| section-header | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| segmented-control | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| select | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| shortcut-hint | `spacing.12→padding`, `radius.none→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| sidebar-nav | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| site-footer | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| site-header | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| site-logo | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| site-nav | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| site-nav-cta | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| source-ledger | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| stat-card | `spacing.12→padding`, `radius.md→radius`, `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo`, `font:Spoqa Han Sans Neo` |
| status-badge | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| status-dot | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| status-summary-row | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| step-progress | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| switch | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| tab-bar | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| tabs | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| tag | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| task-surface-header | `spacing.12→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| testimonial-author | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| testimonial-card | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| testimonial-quote | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| testimonial-section | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| text-field | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| textarea | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| time-picker | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| toast | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| tooltip | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| tooltip-guide | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| topbar | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| trust-strip | `spacing.8→padding`, `radius.none→radius`, `font:Spoqa Han Sans Neo` |
| upgrade-banner | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| user-menu | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
| wizard-layout | `spacing.12→padding`, `radius.md→radius`, `font:Spoqa Han Sans Neo` |
...
- **operational overview**: metric-strip, status-summary-row, task-surface-header, source-ledger, operational-rail, section-header, chart-panel
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | activity-card, breadcrumbs, decision-record-card, feature-card, insight-card, kanban-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | activity-card, breadcrumbs, decision-record-card, feature-card, insight-card, kanban-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Comic panel preview | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Codex image_gen skill | chart-panel, filter-panel, hero-trust-strip, metric-strip, tabs, trust-strip | `public/generated/design-system/manifest.json` | no API fallback |
| Comic panel preview sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Openverse, Wikimedia Commons, Unsplash, Pexels | chart-panel, filter-panel, hero-trust-strip, metric-strip, tabs, trust-strip | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Editorial cover | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Codex image_gen skill | comparison-table, press-quote, ranking-list, review-card, score-badge, editorial | `public/generated/design-system/manifest.json` | no API fallback |
| Editorial cover sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Openverse, Wikimedia Commons, Unsplash, Pexels | comparison-table, press-quote, ranking-list, review-card, score-badge, editorial | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
| Pinterest-assisted capture | active | manual-or-playwright-capture | search assist and shortlist support |

| Context | Provider | Provenance | Allowed Use |
|---------|----------|------------|-------------|
| audit-log-dense-table | Local visual references | observed | flows: data-review, dashboard; morphology: dense-table, timeline |
| dense audit log table interface | Lazyweb MCP real-app corpus | planned | flows: data-review; morphology: dense-table, timeline |
| minimal enterprise landing page | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| ops-dashboard-verified-grid | Local visual references | observed | flows: data-review, dashboard; morphology: dense-table, timeline |
| technical archive dashboard ui | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
