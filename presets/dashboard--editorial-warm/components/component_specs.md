...
총 170개 컴포넌트 | 패밀리: button, commerce, copilot-artifact, copilot-chat, dashboard-editorial, data-display, document, editorial, feedback, input, magazine, marketing, navigation, overlay, social
...
**역할**: 섹션/카테고리/태그 체계 편집 — tree + data-table + modal-dialog, sidebar-nav 진입, muted warm divider
