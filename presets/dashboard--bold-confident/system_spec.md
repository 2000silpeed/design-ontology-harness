...
- **Heading note**: geometric sans with impact, workspace header / KPI metric headline / activation-funnel stage label / cohort-matrix header — serif 금지
- **Body note**: dense data table cell / filter chip / ticket row / referral copy 공용, line-height 1.4–1.5 (dashboard dense)
...
- **Loading**: Inter(preload), Space Grotesk(preload), Pretendard(preload), JetBrains Mono(lazy) | display: swap
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=139.3): masthead_energy=Pure Red, cover_signal=Scarlet, paper_field=Buttercream, feature_frame=Ultra Violet, attention_flash=Illuminating
  - ontology-quiet-surface-2 (Quiet Surface, score=83.4): masthead_energy=Scarlet, cover_signal=Lemon Yellow, paper_field=Kelly Green, feature_frame=Midnight Violet, attention_flash=Royal Purple
  - ontology-clear-structure-3 (Clear Structure, score=90.5): masthead_energy=Scarlet, cover_signal=Lemon Yellow, paper_field=Kelly Green, feature_frame=Royal Purple, attention_flash=Illuminating
  - ontology-strong-signal-4 (Strong Signal, score=101.0): masthead_energy=Pure Orange, cover_signal=Lemon Yellow, paper_field=Kelly Green, feature_frame=Ultra Violet, attention_flash=Pure Red
  - ontology-cross-family-5 (Cross Family, score=89.2): masthead_energy=Lemon Yellow, cover_signal=Kelly Green, paper_field=Buttercream, feature_frame=Byzantium, attention_flash=Pure Red
- **Selection rules**:
...
- **Matched color keywords**:
  - `primary` -> Ultra Violet #5F4B8B / violet.pantone_trend / mood=창의적, 신비감, 미래적 / axes=mid_value, high_chroma, mid_chroma
  - `accent` -> Illuminating #F5DF4D / yellow.pantone_trend / mood=긍정적, 활기찬, 낙관적 / axes=high_value, mid_chroma, warm_bias
  - `surface_tint` -> Creamsicle #FFD7A0 / orange.pastel / mood=부드러움, 경쾌함, 청량함 / axes=high_value, low_chroma, warm_bias
- **Ontology keyword recommendations**:
  - Pure Red #FF0000 / red.standard / matches 'standard'; matches 'high'
  - Scarlet #FF2400 / red.standard / matches 'standard'; matches 'high'
  - Iris Violet #5A4FCF / violet.natural / matches 'violet'; matches 'high'
  - Kelly Green #4CBB17 / green.standard / matches 'standard'; matches 'high'
  - Lemon Yellow #FFF44F / yellow.standard / matches 'standard'; matches 'yellow'
...
- **Density**: dense (confidence 0.52, provenance inferred) / dashboard x2.55, table x3.5, analytics x0.45
- **Surface Style**: tinted (confidence 0.14, provenance inferred) / warm x0.30000000000000004, editorial x0.1
- **Corner Style**: medium (confidence 0.2, provenance inferred) / card x2.6
- **Typography Mood**: utilitarian (confidence 0.5, provenance inferred) / dashboard x2.55, admin x3.0999999999999996, table x3.5
- **Color balance**: temperature=unknown, contrast=unknown, neutral_bias=unknown, provenance=unverified

### Layout Rhythm

- **Dashboard grid**: confidence 0.52 / provenance inferred / dashboard x2.55, analytics x0.45, metric x0.8, kpi x2.6
- **Data review surface**: confidence 0.52 / provenance inferred / table x3.5, data x2.6, filter x3.15
- **Split-pane workspace**: confidence 0.52 / provenance inferred / workspace x0.9, sidebar x1.8, shell x0.9, navigation x0.9
- **Narrative landing flow**: confidence 0.32 / provenance inferred / landing x0.15, hero x0.3, cta x2.4
...
- **Flow coverage**:
  - general-product-ui: covered (3 context cards; lazyweb)
  - dashboard: covered (2 context cards; lazyweb)
  - settings: covered (1 context cards; lazyweb)
...
- **Context cards**:
  - `research-query-01` (research-query, planned): retool admin console / flows: settings / morphology: general-interface-composition
  - `research-query-02` (research-query, planned): appsmith internal tool / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-03` (research-query, planned): stripe radar dashboard / flows: dashboard / morphology: general-interface-composition
  - `research-query-04` (research-query, planned): posthog activation funnel / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-05` (research-query, planned): plausible analytics dashboard / flows: dashboard / morphology: general-interface-composition
- **Research gaps**:
...
- **Required families**: button, data-display, document, feedback, input, layout, marketing, navigation, workflow, commerce, dashboard-growth, foundation, overlay, social
...
- **filter-builder** (input, score 10): users need AND/OR logic across several fields; filters should be saved, shared, or audited / pairs with: saved-view-bar, bulk-action-table, exception-queue
...
- **resizable-split-pane** (layout, score 8): primary work happens between list, canvas/chat, and detail panels; users need to compare or inspect adjacent information without navigation / pairs with: thread-list, artifact-preview-panel, inspector-drawer
- **audit-timeline** (data-display, score 6): regulated workflows require traceable user and AI actions; reviewers need to reconstruct what happened before approval / pairs with: decision-record-card, approval-rail, tool-call-trace
- **decision-record-card** (data-display, score 6): a reviewer or AI-assisted workflow reaches a durable decision; regulated teams need record ids and retention status / pairs with: audit-timeline, approval-rail, citation-drawer
- **inspector-drawer** (overlay, score 6): a selected item needs rich detail without leaving the main workflow; users need source facts, owners, versions, or retention metadata / pairs with: policy-matrix, citation-drawer, decision-record-card
...
- **Marketing hero stack** (marketing / 0.35): hero-section, hero-headline, hero-visual, cta-button-group, trust-strip

- **button**: primary-button, secondary-button, icon-button, form-actions, hero-cta-group, follow-button, add-to-cart-button, wishlist-toggle
...
- **feedback**: badge, inline-alert, empty-state, toast, status-dot, status-badge, banner, empty-feed-illustration
- **input**: text-field, select, checkbox, switch, segmented-control, segment-filter, filter-chip, chip
...
- **navigation**: scope-switcher, breadcrumbs, tabs, pagination, filter-bar, operational-rail, app-shell, sidebar-nav
...
- **overlay**: command-palette, dialog, popover, tooltip, autocomplete, chart-tooltip, confirm-dialog, mention-popup
...
|-----------|-------------|
| activation-funnel | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| activity-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| add-to-cart-button | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| admonition-block | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| alert-list | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| app-shell | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| approval-rail | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| audit-timeline | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| autocomplete | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| avatar | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| avatar-cluster | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| badge | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| banner | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumb | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumbs | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| callout | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| category-pill | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-container | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-legend | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-tooltip | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chat-input | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| checkbox | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chip | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| cohort-matrix | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| color-swatch-selector | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| column-header | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| command-palette | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| command-result-item | `spacing.12→padding`, `radius.none→radius`, `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter`, `font:Inter` |
| comment-input | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| comment-thread | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| confidence-meter | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| confirm-dialog | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| conversion-funnel | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| cross-sell-grid | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| customer-logo | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| data-table | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| date-picker | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| date-range-picker | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| decision-record-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| dialog | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| discount-badge | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| empty-feed-illustration | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| empty-state | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| exception-queue | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| experiment-panel | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| feed-item | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| filter-bar | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-builder | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-chip | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-panel | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-sidebar | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| follow-button | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-actions | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-section | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| gentle-toast | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| goal-tracker | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| hero-container | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-cta-group | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-eyebrow | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-headline | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-subheadline | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-trust-strip | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-visual | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| icon-button | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| image-thumbnail | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| inline-alert | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| insight-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| inspector-drawer | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| kanban-board | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| kanban-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| kanban-column | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| logo-cloud | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| mention-popup | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| metric-highlight | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| metric-strip | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| operational-rail | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| original-price-strikethrough | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| pagination | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| policy-matrix | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| popover | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| post-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| press-quote | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| price-tag | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| primary-button | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| product-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| product-hero-image | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| profile-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| quick-view-modal | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| radio-group | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| reaction-bar | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| referral-widget | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| reply-composer | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| resizable-split-pane | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| retention-chart | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| risk-summary-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| row-actions | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| saved-view-bar | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| scope-switcher | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-field | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-results | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| secondary-button | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| section-header | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| segment-filter | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| segmented-control | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| select | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| share-sheet | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| shortcut-hint | `spacing.12→padding`, `radius.none→radius`, `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter`, `font:Inter` |
| sidebar-nav | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| size-selector | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| soft-dialog | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| sort-dropdown | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| source-ledger | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| stat-card | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-badge | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-dot | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-summary-row | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| step-progress | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| switch | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tab-bar | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tabs | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| text-field | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| textarea | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| thread-view | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| ticket-queue | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| time-picker | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| timeline-stream | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| toast | `color.Creamsicle→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip-guide | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| topbar | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| user-list | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| user-menu | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| variant-selector | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| wishlist-toggle | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| wizard-layout | `color.Ultra Violet→surface`, `color.Illuminating→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | activity-card, add-to-cart-button, breadcrumbs, category-pill, color-swatch-selector, cross-sell-grid | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | activity-card, add-to-cart-button, breadcrumbs, category-pill, color-swatch-selector, cross-sell-grid | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Comic panel preview | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Codex image_gen skill | experiment-panel, filter-panel, hero-trust-strip, metric-strip, tabs | `public/generated/design-system/manifest.json` | no API fallback |
| Comic panel preview sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Openverse, Wikimedia Commons, Unsplash, Pexels | experiment-panel, filter-panel, hero-trust-strip, metric-strip, tabs | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Editorial cover | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Codex image_gen skill | press-quote, marketing | `public/generated/design-system/manifest.json` | no API fallback |
| Editorial cover sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector artwork exists | Openverse, Wikimedia Commons, Unsplash, Pexels | press-quote, marketing | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
| Hero image | generated | high-fidelity-raster-support; SVG: False | Codex image_gen skill | hero-container, hero-cta-group, hero-eyebrow, hero-headline, hero-subheadline, hero-trust-strip | `public/generated/design-system/manifest.json` | no API fallback |
| Hero image sourced fallback | sourced | high-fidelity-raster-support; SVG: False | Openverse, Wikimedia Commons, Unsplash, Pexels | hero-container, hero-cta-group, hero-eyebrow, hero-headline, hero-subheadline, hero-trust-strip | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
|---------|----------|------------|-------------|
| appsmith internal tool | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| mixpanel cohort matrix | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: dense-table |
| plausible analytics dashboard | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
| posthog activation funnel | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| retool admin console | Lazyweb MCP real-app corpus | planned | flows: settings; morphology: general-interface-composition |
| stripe radar dashboard | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
