...
- **Heading note**: geometric sans, 영문/숫자 가독성 — editorial serif 와 명확히 반대 방향
- **Body note**: 본문/레퍼런스 공용, reading measure 65–75ch
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=116.8): masthead_energy=Pure Red, cover_signal=Scarlet, paper_field=Buttercream, feature_frame=Ultra Violet, attention_flash=Illuminating
  - ontology-quiet-surface-2 (Quiet Surface, score=71.8): masthead_energy=Grenadine, cover_signal=Classic Blue, paper_field=Azure Blue, feature_frame=Byzantium, attention_flash=Blue Atoll
  - ontology-clear-structure-3 (Clear Structure, score=77.4): masthead_energy=Scarlet, cover_signal=Blue Atoll, paper_field=Grenadine, feature_frame=Classic Blue, attention_flash=Illuminating
  - ontology-strong-signal-4 (Strong Signal, score=80.8): masthead_energy=Azure Blue, cover_signal=Cobalt Violet, paper_field=Scarlet, feature_frame=Ultra Violet, attention_flash=Classic Blue
  - ontology-cross-family-5 (Cross Family, score=77.8): masthead_energy=Super Sonic, cover_signal=Classic Blue, paper_field=Buttercream, feature_frame=Midnight Violet, attention_flash=Arcadia
- **Selection rules**:
...
- **Matched color keywords**:
  - `primary` -> Iris Violet #5A4FCF / violet.natural / mood=신성함, 예술적, 정제된 생동감 / axes=mid_value, high_chroma, cool_bias
  - `accent` -> Cerulean #2A52BE / blue.standard / mood=안정감, 명료함, 신뢰 / axes=mid_value, mid_chroma
  - `surface_tint` -> Lavender Mist #E6E6FA / violet.pastel / mood=청명함, 정화, 몽환 / axes=high_value, low_chroma, cool_bias
- **Ontology keyword recommendations**:
  - Navy Blue #000080 / blue.deep / matches 'reference'; matches 'cool'
  - Ice Blue #D6EAF8 / blue.pastel / matches 'low_chroma'; matches 'reference'
  - Cascade #76C1B1 / green.pantone_trend / matches 'low_chroma'; matches 'reference'
  - Midnight Violet #2E1A47 / violet.deep / matches 'low_chroma'; matches 'reference'
  - Azure Blue #007FFF / blue.standard / matches 'reference'; matches 'cool'
...
- **Density**: dense (confidence 0.52, provenance inferred) / table x4.4
- **Surface Style**: flat (confidence 0.17, provenance inferred) / minimal x0.75
- **Corner Style**: medium (confidence 0.15, provenance inferred) / card x0.9
- **Typography Mood**: editorial (confidence 0.26, provenance inferred) / editorial x0.30000000000000004, article x1.8, magazine x0.25
- **Color balance**: temperature=unknown, contrast=unknown, neutral_bias=unknown, provenance=unverified

### Layout Rhythm

- **Data review surface**: confidence 0.52 / provenance inferred / table x4.4
- **Split-pane workspace**: confidence 0.42 / provenance inferred / sidebar x3.0500000000000003, breadcrumb x0.45
- **Dashboard grid**: confidence 0.4 / provenance inferred / table x4.4
- **Editorial feed**: confidence 0.29 / provenance inferred / editorial x0.30000000000000004, article x1.8, magazine x0.25
...
- **Context cards**:
  - `research-query-01` (research-query, planned): linear docs reference / flows: general-product-ui / morphology: evidence
  - `research-query-02` (research-query, planned): stripe documentation api / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-03` (research-query, planned): vercel docs technical / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-04` (research-query, planned): mdn reference layout / flows: general-product-ui / morphology: evidence
- **Research gaps**:
...
- **Required families**: button, copilot-artifact, data-display, document, editorial, feedback, input, marketing, navigation, workflow, overlay
...
- **source-card** (copilot-artifact, score 10): AI output depends on external or internal source records; users need a repeatable citation preview component / pairs with: citation-drawer, evidence-graph, inline-citation
- **redline-viewer** (document, score 7): legal, compliance, or editorial text needs reviewer markup; comments must stay anchored to exact text ranges / pairs with: diff-viewer, comment-thread, approval-rail
...
- **diff-viewer** (document, score 6): AI rewrites, policy edits, or reviewer changes need auditability; users must approve what changed before publishing / pairs with: redline-viewer, revision-timeline, approval-rail
...
- **Editorial content block** (editorial / 0.37): content-card, featured-story-card, section-header, content-meta, byline-row

- **button**: primary-button, secondary-button, icon-button, copy-code-button, form-actions, hero-cta-group
- **copilot-artifact**: source-card, citation-drawer
- **data-display**: data-table, column-header, row-actions, search-results, kanban-board, kanban-column, kanban-card, metric-strip
...
- **navigation**: breadcrumbs, tabs, pagination, prev-next-pager, version-switcher, app-shell, sidebar-nav, topbar
- **workflow**: approval-rail
- **overlay**: dialog, popover, tooltip, autocomplete, confirm-dialog, tooltip-guide, command-palette, command-result-item
...
|-----------|-------------|
| admonition-block | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| api-reference-table | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| app-shell | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| autocomplete | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| badge | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| banner | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| block-controls | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| breadcrumb | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumbs | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| bulk-action-table | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| callout | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chat-input | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| checkbox | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chip | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| citation-drawer | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| code-block | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| column-header | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| command-palette | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| command-result-item | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| comment-input | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| comment-thread | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| confirm-dialog | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| copy-code-button | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| data-table | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| dialog | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| empty-state | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| evidence-graph | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| filter-chip | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-panel | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| footnote | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| form-actions | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-section | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| heading-anchor | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| hero-container | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-cta-group | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-eyebrow | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-headline | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-subheadline | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-trust-strip | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| hero-visual | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| icon-button | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| inline-alert | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| kanban-card | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| link-card | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| mention-popup | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| metric-strip | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| operational-rail | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| pagination | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| parameter-table | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| popover | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| prev-next-pager | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| primary-button | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| prose-block | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| radio-group | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| reviewer-assignment-picker | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| row-actions | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| search-field | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-results | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| secondary-button | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| section-header | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| segmented-control | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| select | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| shortcut-hint | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| sidebar-nav | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| slash-command-menu | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| source-card | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| source-ledger | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| status-badge | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-dot | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| status-summary-row | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| step-progress | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| switch | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tab-bar | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| table-of-contents | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| tabs | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tag | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| task-surface-header | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| text-field | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| textarea | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| toast | `color.Lavender Mist→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip-guide | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| topbar | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| version-switcher | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| wizard-layout | `color.Iris Violet→surface`, `color.Cerulean→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | breadcrumbs, kanban-card, link-card, source-card, switch, data-display | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | breadcrumbs, kanban-card, link-card, source-card, switch, data-display | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
|---------|----------|------------|-------------|
| linear docs reference | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: evidence |
| mdn reference layout | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: evidence |
| stripe documentation api | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| vercel docs technical | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
