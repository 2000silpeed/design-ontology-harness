...
- **Source**: Semantic OS color ontology (None)
...
- **Active roles**:
  ...
  - `proof_accent` -> Burnt Orange #CC5500 / orange.deep
- **Selected colors**:
  ...
  - Burnt Orange #CC5500 / orange.deep / 따뜻함, 향수, 빈티지, 성숙함
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=155.78): anchor_background=Navy Blue, depth_support=Prussian Blue, interface_surface=Classic Blue, highlight_air=Ice Blue, proof_accent=Burnt Orange
  - ontology-quiet-surface-2 (Quiet Surface, score=100.62): anchor_background=Prussian Blue, depth_support=Ice Blue, interface_surface=Misty Blue, highlight_air=Cornsilk, proof_accent=Autumn Blaze
  - ontology-clear-structure-3 (Clear Structure, score=102.72): anchor_background=Prussian Blue, depth_support=Forest Green, interface_surface=Navy Blue, highlight_air=Teal Blue, proof_accent=Burnt Orange
  - ontology-strong-signal-4 (Strong Signal, score=113.12): anchor_background=Burnt Orange, depth_support=Byzantium, interface_surface=Prussian Blue, highlight_air=Ice Blue, proof_accent=Honey Gold
  - ontology-cross-family-5 (Cross Family, score=113.62): anchor_background=Burnt Orange, depth_support=Byzantium, interface_surface=Classic Blue, highlight_air=Prussian Blue, proof_accent=Autumn Blaze
- **Selection rules**:
...
- **Matched color keywords**:
  ...
  - `proof_accent` -> Burnt Orange #CC5500 / orange.deep / mood=따뜻함, 향수, 빈티지 / axes=low_value, high_chroma, mid_chroma
- **Ontology keyword recommendations**:
  ...
  - Chili Oil #944537 / orange.pantone_trend / matches 'orange'; matches '고급스러움'
  - Ochre Yellow #CB9D06 / yellow.deep / matches 'warm'; matches 'deep'
...
- **Required families**: button, data-display, document, feedback, input, navigation, workflow, overlay
...
- **approval-rail** (workflow, score 2): work requires review, approval, rejection, or handoff; users need to know who owns the next decision / pairs with: policy-matrix, risk-summary-card, diff-viewer
- **confidence-meter** (feedback, score 2): AI or policy outcome includes uncertainty; users must decide whether to trust, edit, or escalate / pairs with: risk-summary-card, policy-matrix, tool-call-trace
- **decision-record-card** (data-display, score 2): a reviewer or AI-assisted workflow reaches a durable decision; regulated teams need record ids and retention status / pairs with: audit-timeline, approval-rail, citation-drawer
- **inspector-drawer** (overlay, score 2): a selected item needs rich detail without leaving the main workflow; users need source facts, owners, versions, or retention metadata / pairs with: policy-matrix, citation-drawer, decision-record-card
- **risk-summary-card** (data-display, score 2): users need a fast read of risk before drilling into policy details; AI confidence or compliance severity must be visible / pairs with: policy-matrix, confidence-meter, exception-queue
...
- **data-display**: data-table, column-header, row-actions, tag, feature-comparison, section-header, avatar, profile-card
...
- **overlay**: dialog, popover, tooltip, confirm-dialog, user-menu, tooltip-guide, chart-tooltip, autocomplete
...
이 문서는 **ColorFit System**의 디자인 시스템 사양입니다.
...
핵심 primitive: **personal color onboarding, recommendation feed, outfit detail and comparison, shopping price comparison, closet analysis**
...
- **Warm**: warm와 충돌하는 컴포넌트 변형은 만들지 않기
- 모든 시각적 선택에서 **editorial, precise, trustworthy** 기준을 적용
...
- **clinical** 방향의 디자인 결정을 하지 않음
- **cheap** 방향의 디자인 결정을 하지 않음
...
| Burnt Orange | Ink | 4.38:1 | AA-large (large-only) |
| Burnt Orange | Paper | 4.31:1 | AA-large (large-only) |
| Navy Blue | Burnt Orange | 3.71:1 | AA-large (large-only) |
| Ice Blue | Burnt Orange | 3.49:1 | AA-large (large-only) |
| Prussian Blue | Burnt Orange | 3.11:1 | AA-large (large-only) |
| Classic Blue | Ink | 2.13:1 | fail (FAIL) |
| Classic Blue | Burnt Orange | 2.05:1 | fail (FAIL) |
...
- **operational overview**: section-header
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | breadcrumbs, decision-record-card, kanban-card, pricing-card, profile-card, risk-summary-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | breadcrumbs, decision-record-card, kanban-card, pricing-card, profile-card, risk-summary-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Comic panel preview | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Codex image_gen skill | filter-panel, tabs | `public/generated/design-system/manifest.json` | no API fallback |
| Comic panel preview sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Openverse, Wikimedia Commons, Unsplash, Pexels | filter-panel, tabs | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
