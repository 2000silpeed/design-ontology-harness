...
//
// Why not commit the binary? OFL permits redistribution, but we prefer to
// pull from upstream at install-time so users always get the latest glyphs
// and license notices.

import { mkdirSync, writeFileSync, existsSync } from "node:fs";
import { join, dirname } from "node:path";

const TARGET = "public/fonts/PretendardVariable.woff2";
const URL =
...
async function main() {
  ...
  console.log(
    "[pretendard] see public/fonts/LICENSE-FONTS for SIL OFL 1.1 notice."
  );
}
