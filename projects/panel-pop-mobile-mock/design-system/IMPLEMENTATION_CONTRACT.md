...
- `lint-implementation` promotes icon-starved interactive surfaces to DS071, domain-visual gaps to DS072, low-information inline SVG visuals to DS073, amateur ad-hoc illustration to DS074, wrong-medium SVG narrative media to DS079, and undeclared handmade icon sprites to DS080.
...
- `lint-implementation` promotes SVG assets in narrative/content media slots to DS079.
