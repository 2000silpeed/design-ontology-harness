...
- **Heading note**: enterprise neutral sans — workspace-header / thread-title / policy-check 라벨 / compliance-artifact title, 규제 맥락에서 serif 는 지양
- **Body note**: chat-message body / compliance-artifact paragraph / audit-trail description 공용 본문, line-height 1.5–1.6 (enterprise reading)
...
- **Ontology-searched candidate palettes**:
  ...
  - ontology-quiet-surface-2 (Quiet Surface, score=98.75): anchor_surface=Bottle Green, structural_support=Moss Green, quiet_background=Forest Green, calm_border=Lavender Violet, fresh_accent=Classic Blue
  - ontology-clear-structure-3 (Clear Structure, score=101.55): anchor_surface=Hunter Green, structural_support=Olive Green, quiet_background=Midnight Violet, calm_border=Lavender Violet, fresh_accent=Arcadia
  - ontology-strong-signal-4 (Strong Signal, score=109.0): anchor_surface=Olive Green, structural_support=Moss Green, quiet_background=Chili Oil, calm_border=Cascade, fresh_accent=Super Sonic
  - ontology-cross-family-5 (Cross Family, score=99.55): anchor_surface=Olive Green, structural_support=Hunter Green, quiet_background=Celadon, calm_border=Powder Blue, fresh_accent=Ochre
- **Selection rules**:
...
- **Matched color keywords**:
  - `primary` -> Super Sonic #0071A8 / blue.pantone_trend / mood=혁신적, 미래지향적, 역동적 / axes=high_value, high_chroma, mid_chroma
  - `accent` -> Copper #B87333 / orange.deep / mood=고급스러움, 따뜻함, 전통적 질감 / axes=low_value, mid_chroma, warm_bias
...
- **Ontology keyword recommendations**:
  ...
  - Cornsilk #FFF8DC / yellow.pastel / matches 'low_chroma'; matches 'reference'
  - Apricot #FFB27F / orange.natural / matches 'low_chroma'; matches 'reference'
...
- **Density**: balanced (confidence 0.25, provenance inferred) / workspace x3.9499999999999997, product x0.15
- **Surface Style**: elevated (confidence 0.19, provenance inferred) / modal x2.25
- **Corner Style**: round (confidence 0.18, provenance inferred) / soft x0.8
- **Typography Mood**: utilitarian (confidence 0.42, provenance inferred) / admin x0.45, enterprise x5.75
- **Color balance**: temperature=unknown, contrast=unknown, neutral_bias=unknown, provenance=unverified

### Layout Rhythm

- **Conversation side panel**: confidence 0.52 / provenance inferred / chat x3.35, assistant x0.45, message x4.5, thread x2.7
- **Split-pane workspace**: confidence 0.52 / provenance inferred / workspace x3.9499999999999997, sidebar x2.6
- **Data review surface**: confidence 0.5 / provenance inferred / grid x0.15, audit x4.000000000000001, data x0.9, timeline x2.6

### Image-derived Component Hints

- **Cards**: raised cards with restrained depth를 기본으로 하고, 균형 잡힌 spacing과 명확한 slot hierarchy. soft round corner를 기본값으로 유지. / provenance inferred / surface=elevated, density=balanced, corner=round
...
- **Context cards**:
  - `research-query-01` (research-query, planned): chatgpt enterprise admin console / flows: settings / morphology: general-interface-composition
  - `research-query-02` (research-query, planned): anthropic claude enterprise workspace / flows: navigation / morphology: general-interface-composition
  - `research-query-03` (research-query, planned): stripe dialog documentation / flows: general-product-ui / morphology: general-interface-composition
  - `research-query-04` (research-query, planned): salesforce einstein assistant / flows: messaging / morphology: general-interface-composition
  - `research-query-05` (research-query, planned): intercom fin ai copilot / flows: general-product-ui / morphology: general-interface-composition
- **Research gaps**:
...
- **Required families**: button, copilot-artifact, copilot-chat, data-display, document, editorial, feedback, input, layout, marketing, navigation, workflow, commerce, overlay, social
...
- **data-display**: chat-message, chat-thread, comment-thread, tag, metric-strip, status-summary-row, task-surface-header, source-ledger
...
- **feedback**: badge, inline-alert, empty-state, toast, status-dot, status-badge, empty-conversation-state, banner
- **input**: text-field, select, checkbox, switch, segmented-control, chat-input, comment-input, chip
- **layout**: resizable-split-pane
- **marketing**: logo-cloud, customer-logo, metric-highlight, press-quote, faq-section, faq-item, faq-question, faq-answer
...
- **overlay**: dialog, popover, tooltip, mention-popup, confirm-dialog, user-menu, autocomplete, tooltip-guide
...
|-----------|-------------|
| add-to-cart-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| app-shell | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| artifact-preview-panel | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| audit-timeline | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| autocomplete | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| breadcrumb | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| breadcrumbs | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| calendar-grid | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| category-pill | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-container | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-legend | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chart-tooltip | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chat-input | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| checkbox | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| chip | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| citation-drawer | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| citation-footnote | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| color-swatch-selector | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| column-header | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| command-palette | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| command-result-item | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| comment-input | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| comment-thread | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| confirm-dialog | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| date-picker | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| date-range-picker | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| decision-record-card | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| dialog | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| diff-viewer | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| discount-badge | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| empty-conversation-state | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| file-preview | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| filter-chip | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-panel | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| filter-sidebar | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| follow-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| footnote | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| form-actions | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| form-section | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| icon-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| inspector-drawer | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| mention-popup | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| new-thread-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| operational-rail | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
...
| pagination | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| paragraph-block | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| player-controls | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| policy-matrix | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| popover | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| prev-next-pager | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| primary-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| product-card | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| product-hero-image | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| profile-card | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| prompt-composer | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| prose-block | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| quick-view-modal | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| quote-block | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| radio-group | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| regenerate-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| reply-composer | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| resizable-split-pane | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| reviewer-assignment-picker | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| revision-timeline | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| risk-summary-card | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| row-actions | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| search-field | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| search-results | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| secondary-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| section-header | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| segmented-control | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| select | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| share-sheet | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| shortcut-hint | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| sidebar-nav | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| size-selector | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| slash-command-menu | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| soft-dialog | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| sort-dropdown | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| source-card | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| step-progress | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| stop-generation-button | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| streaming-cursor | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| suggestion-card | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| switch | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tab-bar | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| table-of-contents | `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| tabs | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| text-field | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| textarea | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| time-picker | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| tone-slider | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| tooltip-guide | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| topbar | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| upload-dropzone | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| upload-progress | `color.Powder Blue→background`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| user-menu | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| variant-selector | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| video-player | `spacing.12→padding`, `radius.none→radius`, `font:Inter` |
| volume-slider | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
| wishlist-toggle | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.8→padding`, `radius.none→radius`, `font:Inter` |
| wizard-layout | `color.Super Sonic→surface`, `color.Copper→emphasis`, `spacing.12→padding`, `radius.md→radius`, `font:Inter` |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | add-to-cart-button, breadcrumbs, category-pill, color-swatch-selector, cross-sell-grid, decision-record-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | add-to-cart-button, breadcrumbs, category-pill, color-swatch-selector, cross-sell-grid, decision-record-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
| Hero image | generated | high-fidelity-raster-support; SVG: False | Codex image_gen skill | feature-comparison, product-hero-image, marketing | `public/generated/design-system/manifest.json` | no API fallback |
| Hero image sourced fallback | sourced | high-fidelity-raster-support; SVG: False | Openverse, Wikimedia Commons, Unsplash, Pexels | feature-comparison, product-hero-image, marketing | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
|---------|----------|------------|-------------|
| anthropic claude enterprise workspace | Lazyweb MCP real-app corpus | planned | flows: navigation; morphology: general-interface-composition |
| chatgpt enterprise admin console | Lazyweb MCP real-app corpus | planned | flows: settings; morphology: general-interface-composition |
| intercom fin ai copilot | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
| salesforce einstein assistant | Lazyweb MCP real-app corpus | planned | flows: messaging; morphology: general-interface-composition |
| stripe dialog documentation | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: general-interface-composition |
