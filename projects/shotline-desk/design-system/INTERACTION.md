...
- 적용 역할: detail-panel, list-surface, status-region
...
- 적용 역할: list-surface, navigation-surface, selection-target
- 근거 팩: `harness-interaction-candidates`
- 가드레일:
...
- `attention-border` (emphasis, 점수 9)
- `surface-lift` (emphasis, 점수 9)
- `result-reveal` (enter, 점수 7)
- `anchored-shift` (transition, 점수 6)
- `determinate-bar` (progress, 점수 6)
- `dot-progress` (progress, 점수 5)
- `inline-expand` (enter, 점수 5)
- `staged-enter` (enter, 점수 4)
