# FairCite Evidence Console System Spec

## 1. Positioning

- **Brand**: FairCite
- **Product**: 공정거래위원회 의결서 500건을 chunk 단위까지 추적 가능한 형태로 재구성한 근거추적 듀얼 모드 웹서비스. 본사·원청은 사전 예방용으로, 가맹점주·수급사업자는 사후 인지·대응용으로 같은 데이터를 다른 시점에서 활용한다.
- **Audience**: 기업 컴플라이언스팀 — 자사 거래구조와 산업 영역의 공정거래 리스크를 사전 점검하고 사내 보고용 근거 자료를 만드는 실무자, 사내 법무팀 변호사 — 의결서 chunk, 현행 조문, 처분 사례를 빠르게 비교해 외부 의견서 전 단계의 조사 근거를 확보하는 전문가, 가맹점주·중소 수급사업자·중소 입찰업체 — 자신이 겪은 상황과 공정위 인정 유사 패턴을 비교하고 사실관계 정리와 증거 체크리스트를 준비하는 사용자, 공모전 평가위원 — Track 2 서비스 결과물이 자동지표와 분리되어 있고 정성 5축을 명확히 증명하는지 빠르게 확인하는 심사자
- **Platforms**: web, desktop-web, responsive-web
- **Accessibility floor**: WCAG 2.2 AA, keyboard navigable, high contrast source labels, Korean keep-all line wrapping

## 2. Identity Guardrails

- **Brand keywords**: fair-trade, evidence-traceability, decision-document, chunk-citation, dual-mode-console, compliance, rights-protection, legal-reference, law-diff, sanction-anatomy, case-briefing, source-label, policy-grade, calm-authoritative, korean-public-service
- **Anti-keywords**: marketing-landing, hero-heavy, decorative-gradient, cartoon-legal, one-note-purple, one-note-blue, beige-law-office, black-box-ai, legal-advice-claim, prediction-focused, consumer-social-feed, overdecorated-card-stack
- **Tone of voice**: 정확한, 차분한, 근거 중심, 법률 자문이 아닌 참고 판단, 평이하지만 단정하지 않는, 공공 서비스처럼 신뢰감 있는
- **Visual direction**: dense evidence console, public-sector trust, split-pane workflow, citation drawer, source label badges, legal document snippets, structured risk matrix, paired case comparison, law lookup hover, neutral surfaces with restrained status accents, Korean professional UI, audit-friendly data panels
- **Interaction direction**: mode switch between compliance and shield, right-side evidence drawer, inline chunk citation reveal, source label tooltip, law hover lookup, risk matrix drilldown, sanction structure stepper, pattern catalog card select, paired case perspective toggle, clear inputs privacy action, PDF export affordance, keyboard-friendly dashboard navigation

## 3. Design Principles

- **Fair-Trade**: `fair-trade`를 시각적 선택과 인터랙션 선택의 기본 기준으로 삼습니다.
- **Evidence-Traceability**: `evidence-traceability`를 시각적 선택과 인터랙션 선택의 기본 기준으로 삼습니다.
- **Decision-Document**: `decision-document`를 시각적 선택과 인터랙션 선택의 기본 기준으로 삼습니다.
- **Chunk-Citation**: `chunk-citation`를 시각적 선택과 인터랙션 선택의 기본 기준으로 삼습니다.
...
- **Heading note**: Korean public-service dashboard heading. 영문/숫자와 한글 혼합에서도 안정적인 professional tone.
- **Body note**: 의결서 요약, 법령 안내, 카드 설명에 사용. keep-all line wrapping과 1.45~1.6 line-height 권장.
...
- **Preferred families**: Standard Blues, Pantone Trend Blues, Standard Greens, Standard Oranges, Standard Violets
...
- **Palette candidates**:
  ...
  - soft-spread-2 (Soft Spread): primary=Ochre, accent=Emerald Green, surface_tint=Misty Blue / Ochre is inside preferred families.; Emerald Green is inside preferred families.
- **Expanded supporting colors**:
  - Azure Blue #007FFF / Standard Blues / reference-color / Azure Blue stays inside the preferred families.
  - Blue Atoll #00B1D2 / Pantone Trend Blues / reference-color / Blue Atoll stays inside the preferred families.
  - Cerulean #2A52BE / Standard Blues / reference-color / Cerulean stays inside the preferred families.
  - Classic Blue #0F4C81 / Pantone Trend Blues / reference-color / Classic Blue stays inside the preferred families.
  - Cobalt Violet #804AA8 / Standard Violets / reference-color / Cobalt Violet stays inside the preferred families.
  - Emerald Green #50C878 / Standard Greens / reference-color / Emerald Green stays inside the preferred families.
  - Kelly Green #4CBB17 / Standard Greens / reference-color / Kelly Green stays inside the preferred families.
  - Ochre #CC7722 / Standard Oranges / reference-color / Ochre stays inside the preferred families.
...
- **Combination lists**:
  ...
  - Support Spectrum: support=Azure Blue, support=Blue Atoll, support=Cerulean, support=Classic Blue, support=Cobalt Violet, support=Emerald Green
...
- **Ontology-searched candidate palettes**:
  - ontology-best-fit-1 (Best Fit, score=165.75): anchor_surface=Forest Green, structural_support=Bottle Green, quiet_background=Celadon, calm_border=Cascade, fresh_accent=Arcadia
  - ontology-quiet-surface-2 (Quiet Surface, score=116.85): anchor_surface=Bottle Green, structural_support=Forest Green, quiet_background=Mint Green, calm_border=Buttercream, fresh_accent=Hunter Green
  - ontology-clear-structure-3 (Clear Structure, score=120.95): anchor_surface=Moss Green, structural_support=Celadon, quiet_background=Hunter Green, calm_border=Prussian Blue, fresh_accent=Arcadia
  - ontology-strong-signal-4 (Strong Signal, score=120.85): anchor_surface=Hunter Green, structural_support=Mint Green, quiet_background=Moss Green, calm_border=Cascade, fresh_accent=Forest Green
  - ontology-cross-family-5 (Cross Family, score=119.45): anchor_surface=Mint Green, structural_support=Midnight Violet, quiet_background=Celadon, calm_border=Buttercream, fresh_accent=Ochre
- **Selection rules**:
...
- **Ontology keyword recommendations**:
  ...
  - Buttercream #F3E5AB / yellow.pastel / matches 'low_chroma'; matches 'reference'
...
- **Notes**: Primary는 공공·데이터 신뢰를 주는 청록/블루 계열을 우선하되, 화면 전체가 한 가지 파랑으로 읽히지 않도록 한다., Accent는 법령·주의·권익보호 모드를 구분하는 절제된 오렌지/골드 계열을 허용한다., Evidence label 4종은 primary/accent/success/violet 역할로 분리해 출처 유형을 즉시 구분하게 한다., Canvas는 밝은 회색 계열, panel은 white 중심. dark blue/slate one-note dashboard로 흐르지 않게 한다.
...
- **Query seeds**: government evidence dashboard split pane, legal research citation drawer, compliance risk matrix enterprise console, public service data dashboard korean, audit trail evidence map UI, source citation card dense dashboard
### Visual Direction

- **Density**: dense (confidence 0.38, provenance inferred) / dashboard x2.7
- **Surface Style**: flat (confidence 0.13, provenance inferred) / fallback=flat
- **Corner Style**: medium (confidence 0.26, provenance inferred) / card x4.6
- **Typography Mood**: utilitarian (confidence 0.36, provenance inferred) / dashboard x2.7, enterprise x0.45
- **Color balance**: temperature=unknown, contrast=unknown, neutral_bias=unknown, provenance=unverified

### Layout Rhythm

- **Data review surface**: confidence 0.51 / provenance inferred / audit x1.25, data x2.35, comparison x1.7000000000000002
- **Dashboard grid**: confidence 0.43 / provenance inferred / dashboard x2.7, metric x0.9
- **Split-pane workspace**: confidence 0.36 / provenance inferred / sidebar x0.9, app x0.9, shell x0.9, navigation x1.35
...
- Avoid: hero landing page
- Avoid: decorative orbs
- Avoid: nested cards
- Avoid: stock legal imagery
...
- **Flow coverage**:
  ...
  - document: covered (2 context cards; lazyweb)
...
- **Context cards**:
  - `research-query-01` (research-query, planned): government evidence dashboard split pane / flows: dashboard / morphology: split-pane, evidence
  - `research-query-02` (research-query, planned): legal research citation drawer / flows: document / morphology: evidence, split-pane
  - `research-query-03` (research-query, planned): compliance risk matrix enterprise console / flows: general-product-ui / morphology: dense-table
  - `research-query-04` (research-query, planned): public service data dashboard korean / flows: dashboard / morphology: general-interface-composition
  - `research-query-05` (research-query, planned): audit trail evidence map UI / flows: data-review / morphology: dense-table, evidence, timeline
- **Research gaps**:
...
- **Product primitives**: app shell, mode selector, sidebar navigation, privacy banner, diagnosis form, structured textarea, segmented controls, risk matrix, risk row meter, case result card, citation drawer, source label badge, source label tooltip, evidence map, chunk card, law lookup card, sanction anatomy stepper, pattern catalog, paired case comparison, metric strip, data status card, legal disclaimer footer, PDF export button, graph preview panel
- **Required families**: button, copilot-artifact, data-display, feedback, input, marketing, navigation, workflow, overlay
...
- **approval-rail** (workflow, score 14): work requires review, approval, rejection, or handoff; users need to know who owns the next decision / pairs with: policy-matrix, risk-summary-card, diff-viewer
...
- **citation-drawer** (copilot-artifact, score 14): answers must show supporting policy, document, or source records; users need to inspect evidence without losing conversation context / pairs with: inline-citation, source-card, evidence-graph
...
- **policy-matrix** (data-display, score 14): multiple policy rules must be checked against multiple claims or fields; reviewers need dense scan-and-drill compliance status / pairs with: risk-summary-card, exception-queue, approval-rail
- **risk-summary-card** (data-display, score 14): users need a fast read of risk before drilling into policy details; AI confidence or compliance severity must be visible / pairs with: policy-matrix, confidence-meter, exception-queue
...
- **Dashboard insight module** (data-display / 0.48): stat-card, insight-card, chart-panel, section-header, filter-chip
- **Data review table** (data-display / 0.48): data-table, column-header, row-actions, filter-toolbar, pagination
- **Workspace shell** (navigation / 0.47): app-shell, sidebar-nav, workspace-switcher, breadcrumb, context-panel
...
- **data-display**: data-table, column-header, row-actions, tag, stat-card, insight-card, activity-card, section-header
- **feedback**: inline-alert, empty-state, toast, status-badge, step-progress, banner
- **input**: text-field, search-field, segmented-control, filter-chip, chip, textarea, select, checkbox
- **marketing**: logo-cloud, customer-logo, metric-highlight, press-quote, hero-container, hero-eyebrow, hero-headline, hero-subheadline
- **navigation**: mobile-topbar, mobile-tab-bar, back-button, section-tabs, pagination, wizard-layout, app-shell, sidebar-nav
- **workflow**: approval-rail
- **overlay**: bottom-sheet, modal-dialog, confirm-dialog, tooltip-guide, chart-tooltip, command-palette
...
이 문서는 **FairCite Evidence Console System**의 디자인 시스템 사양입니다.
...
핵심 primitive: **app shell, mode selector, sidebar navigation, privacy banner, diagnosis form**
...
- **Fair-Trade**: fair-trade와 충돌하는 컴포넌트 변형은 만들지 않기
- **Evidence-Traceability**: evidence-traceability와 충돌하는 컴포넌트 변형은 만들지 않기
- **Decision-Document**: decision-document와 충돌하는 컴포넌트 변형은 만들지 않기
- **Chunk-Citation**: chunk-citation와 충돌하는 컴포넌트 변형은 만들지 않기
- 모든 시각적 선택에서 **fair-trade, evidence-traceability, decision-document** 기준을 적용
...
- **marketing-landing** 방향의 디자인 결정을 하지 않음
- **hero-heavy** 방향의 디자인 결정을 하지 않음
- **decorative-gradient** 방향의 디자인 결정을 하지 않음
- **cartoon-legal** 방향의 디자인 결정을 하지 않음
...
:root {
  ...
  /* --- Feedback — info --- */
  --color-feedback-info-surface: #E0F0FF;
  --color-feedback-info-text: #007FFF;
  --color-feedback-info-border: #4AA3FE;
  --color-feedback-info-icon: #007FFF;

  /* --- Feedback — success --- */
  --color-feedback-success-surface: #EAF8EF;
  --color-feedback-success-text: #50C878;
  --color-feedback-success-border: #82D69F;
...
| approval-rail | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| column-header | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| command-palette | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| confirm-dialog | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| feature-comparison | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| filter-builder | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
| filter-chip | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| policy-matrix | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| row-actions | `spacing.12→padding`, `radius.md→radius`, `font:Pretendard` |
...
| Card thumbnail | generated | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Codex image_gen skill | activity-card, decision-record-card, insight-card, risk-summary-card, section-header, source-card | `public/generated/design-system/manifest.json` | no API fallback |
| Card thumbnail sourced fallback | sourced | content-media; SVG: only for approved product schematics or semantic vector thumbnails | Openverse, Wikimedia Commons, Unsplash, Pexels | activity-card, decision-record-card, insight-card, risk-summary-card, section-header, source-card | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
| Comic panel preview | generated | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Codex image_gen skill | hero-trust-strip | `public/generated/design-system/manifest.json` | no API fallback |
| Comic panel preview sourced fallback | sourced | high-fidelity-narrative-media; SVG: denied unless approved production vector panel art exists | Openverse, Wikimedia Commons, Unsplash, Pexels | hero-trust-strip | `public/generated/design-system/manifest.json` | license-verified sourced visual fallback |
...
- **Implementation rules**:
  ...
  - Do not invent rough hand-drawn scene illustrations inside implementation code as a substitute for product visuals; use image_gen, sourced/user-supplied assets, approved assets, or polished product schematics.
  - Mockups must declare the real app representation for visual surfaces: map SDK/tile layer, generated or sourced media, chart/table, data visualization, or explicit loading/empty state.
  - Do not represent evidence maps, relation maps, or product data graphs as hand-positioned HTML nodes connected by rotated CSS lines. Use a real graph/chart library, semantic SVG/canvas visualization with runtime data, or a ledger/table when the relationship is simple.
  - A media/photo runtime surface is not complete when it is only CSS gradients or texture patterns; it must bind an image/video asset or show an explicit empty/loading state.
  - Operational dashboards, sports/data products, and tools may keep imagery secondary, but should still use domain visuals such as app icons, team/flag identity, venue thumbnails, product objects, or editorial context where they add credibility.
  - Do not let images obscure Korean text or controls; define stable aspect ratios, object-fit/object-position, and mobile crop behavior.
- **Promoted failure patterns**:
  ...
  - ad-hoc-node-link-placeholder-graph: Use a proven graph/chart library, a semantically labeled SVG/canvas visualization backed by real runtime data, or replace simple relationships with an evidence ledger/table. `lint-implementation DS082` blocks `graph-node`/`graph-edge` and `trace-node`/`trace-line` CSS sketches.
...
|---------|----------|------------|-------------|
| audit trail evidence map UI | Lazyweb MCP real-app corpus | planned | flows: data-review; morphology: dense-table, evidence, timeline |
| compliance risk matrix enterprise console | Lazyweb MCP real-app corpus | planned | flows: general-product-ui; morphology: dense-table |
| government evidence dashboard split pane | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: split-pane, evidence |
| legal research citation drawer | Lazyweb MCP real-app corpus | planned | flows: document; morphology: evidence, split-pane |
| public service data dashboard korean | Lazyweb MCP real-app corpus | planned | flows: dashboard; morphology: general-interface-composition |
| source citation card dense dashboard | Lazyweb MCP real-app corpus | planned | flows: dashboard, document; morphology: evidence, card-stack |
