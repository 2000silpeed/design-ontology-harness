"""Benchmark KB — curated real-service design system references.
...
BENCHMARK_SYSTEMS: list[dict] = [
    ...
    },
    {
        ...
        "token_traits": ["web components", "semantic layers", "responsive scale"],
        ...
        "notable": ["merchant-focused", "web-component UI toolkit", "admin-native patterns"],
    },
    {
        "id": "atlassian",
    ...
    },
    {
        ...
        "token_traits": ["design tokens", "visual modes", "coded demos"],
        "typography": {"heading": "Amazon Ember", "body": "Amazon Ember", "mono": "monospace"},
        "color_strategy": "white and grayscale operational base with focused action/status color",
        "component_count_range": "70-100",
        "notable": ["cloud-console workflows", "patterns and demos", "testing guidance"],
    },
    {
        "id": "hashicorp-helios",
    ...
    },
    {
        ...
        "category": "support",
        "keywords": ["accessible", "systematic", "trustworthy"],
        "token_traits": ["design tokens", "theming", "bedrock CSS"],
        "typography": {"heading": "system-ui", "body": "system-ui", "mono": "monospace"},
        "color_strategy": "support-product neutrals with explicit semantic feedback roles",
        "component_count_range": "70-100",
        "notable": ["support-product surfaces", "Garden 9 component coverage", "theming utilities"],
    },
    {
        "id": "contentful-forma-36",
        "name": "Contentful Forma 36",
        "url": "https://f36.contentful.com",
        "category": "content-platform",
        "keywords": ["accessible", "systematic", "calm"],
        "token_traits": ["design tokens", "Figma libraries", "React components"],
        "typography": {"heading": "Geist", "body": "Geist", "mono": "monospace"},
        "color_strategy": "clean content-platform neutrals with product status accents",
        "component_count_range": "50-80",
        "notable": ["content management workflows", "component playground", "v5 accessibility refresh"],
    },
    {
        "id": "nord-health",
        ...
        "category": "healthcare",
        "keywords": ["calm", "accessible", "trustworthy"],
        "token_traits": ["design tokens", "web components", "theme tokens"],
        "typography": {"heading": "Inter", "body": "Inter", "mono": "monospace"},
        "color_strategy": "clinical neutrals with restrained blue/green action and status colors",
        "component_count_range": "50-80",
        "notable": ["healthcare-grade clarity", "framework-agnostic web components", "command menu pattern"],
    },
    {
        "id": "trimble-modus",
        "name": "Trimble Modus 2.0",
        "url": "https://modus.trimble.com",
        "category": "industrial-enterprise",
        "keywords": ["systematic", "accessible", "precise"],
        "token_traits": ["design tokens", "web components", "AI flow patterns"],
        "typography": {"heading": "Open Sans", "body": "Open Sans", "mono": "monospace"},
        "color_strategy": "enterprise blue core with structured surfaces and semantic states",
        "component_count_range": "50-80",
        "notable": ["multi-framework delivery", "patterns and templates", "AI tooling guidance"],
    },
    {
        "id": "salesforce-slds2",
        "name": "Salesforce Lightning Design System 2",
        "url": "https://www.salesforce.com/blog/experience-design-with-slds-2/",
        "category": "enterprise",
        "keywords": ["systematic", "trustworthy", "accessible"],
        "token_traits": ["styling API", "theme architecture", "dark mode"],
        "typography": {"heading": "Salesforce Sans", "body": "Salesforce Sans", "mono": "monospace"},
        "color_strategy": "composable enterprise theme layer with Cosmos visual refresh",
        "component_count_range": "80-120",
        "notable": ["agentic experience foundation", "dark mode beta", "enterprise theming API"],
    },
    {
        "id": "gitlab-pajamas",
        "name": "GitLab Pajamas",
